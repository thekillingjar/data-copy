...
struct TilingCompatibleLegacyKernelUt : public testing::Test {
...
TEST_F(TilingCompatibleLegacyKernelUt, test_tiling_func_v4_success) {
  // mock tiling func
...
TEST_F(TilingCompatibleLegacyKernelUt, Tiling_Success_WhenFuncSuccess) {
...
TEST_F(TilingCompatibleLegacyKernelUt, Tiling_Failed_WhenFuncFailed) {
