...
class StarsKernelLaunchUT : public testing::Test {
 public:
  KernelRegistry &registry = KernelRegistry::GetInstance();
};

TEST_F(StarsKernelLaunchUT, test_stars_run_launch_kernel) {
  ...
  registry.FindKernelFuncs("StarsTaskLaunchKernel")->trace_printer(context);
}
}  // namespace gert