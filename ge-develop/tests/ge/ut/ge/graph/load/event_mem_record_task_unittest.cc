...
namespace ge {
class UtestEventMemRecordTask : public testing::Test {
 protected:
  void SetUp() {}
...
// test Init_EventMemRecordTaskInfo
TEST_F(UtestEventMemRecordTask, init_and_distribute_event_record_task_info) {
  ...
  EventMemRecordTaskInfo task_info;
