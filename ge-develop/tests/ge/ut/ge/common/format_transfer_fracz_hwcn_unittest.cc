...
TEST_F(UtestFormatTransferFracZHwcn, fracz_to_hwcn_invalid_data_type_invalid_data_type) {
  ...
  TransArgs args{data, src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED, FORMAT_RESERVED, 16, 16,
                 {16, 1, 32, 16}, {4, 4, 1, 1}, DT_UNDEFINED};
  TransResult result;
...
TEST_F(UtestFormatTransferFracZHwcn, fracz_to_hwcn_invalid_src_format_reserved) {
  ...
  const Format dst_format = static_cast<Format>(GetFormatFromSubAndC0(FORMAT_HWCN, FORMAT_RESERVED, 5));
  TransArgs args{
      reinterpret_cast<uint8_t *>(data), src_format, dst_format, FORMAT_RESERVED, FORMAT_HWCN, FORMAT_RESERVED,
      FORMAT_RESERVED, 16, 16, {16, 1, 16, 16}, {4, 4, 1, 1}, DT_FLOAT};
...
TEST_F(UtestFormatTransferFracZHwcn, fracz_to_hwcn_invalid_src_shape) {
  ...
  const Format dst_format = static_cast<Format>(GetFormatFromSubAndC0(FORMAT_HWCN, FORMAT_RESERVED, 5));
  TransArgs args{
      reinterpret_cast<uint8_t *>(data), src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED,
      FORMAT_RESERVED, 16, 16, {16, 1, 1, 16, 16}, {4, 4, 1, 1}, DT_FLOAT};
...
TEST_F(UtestFormatTransferFracZHwcn, fracz_to_hwcn_invalid_dst_shape) {
  ...
  TransArgs args{
      reinterpret_cast<uint8_t *>(data), src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED,
      FORMAT_RESERVED, 16, 16, {16, 1, 16, 16}, {4, 4, 1}, DT_FLOAT};
...
TEST_F(UtestFormatTransferFracZHwcn, fracz_to_hwcn_invalid_src_dst_shape_relation1) {
  ...
  TransArgs args{
      reinterpret_cast<uint8_t *>(data), src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED,
      FORMAT_RESERVED, 16, 16, {16, 1, 16, 16}, {4, 4, 17, 1}, DT_FLOAT};
...
TEST_F(UtestFormatTransferFracZHwcn, fracz_to_hwcn_invalid_src_dst_shape_relation2) {
  ...
  TransArgs args{
      reinterpret_cast<uint8_t *>(data), src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED,
      FORMAT_RESERVED, 16, 16, {16, 1, 16, 16}, {4, 4, 1, 17}, DT_FLOAT};
...
TEST_F(UtestFormatTransferFracZHwcn, fracz_to_hwcn_fp16_success_lt_cube) {
  ...
  const Format dst_format = static_cast<Format>(GetFormatFromSubAndC0(FORMAT_HWCN, FORMAT_RESERVED, 5));
  TransArgs args{
      reinterpret_cast<uint8_t *>(data_4d), src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED,
...
TEST_F(UtestFormatTransferFracZHwcn, fracz_to_hwcn_fp16_success_eq_cube) {
  ...
  TransArgs args{
      reinterpret_cast<uint8_t *>(data_4d), src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED,
      FORMAT_RESERVED, 16, 16, {4, 1, 16, 16}, {2, 2, 16, 16}, DT_FLOAT16};
  TransResult result;
...
TEST_F(UtestFormatTransferFracZHwcn, fracz_to_hwcn_fp16_success_gt_cube) {
  ...
  TransArgs args{
      reinterpret_cast<uint8_t *>(data_4d), src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED,
      FORMAT_RESERVED, 16, 16, {8, 2, 16, 16}, {2, 2, 17, 17}, DT_FLOAT16};
  TransResult result;
...
TEST_F(UtestFormatTransferFracZHwcn, fracz_to_hwcn_fp32_success_eq_cube) {
  ...
  TransArgs args{
      reinterpret_cast<uint8_t *>(data_4d), src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED,
      FORMAT_RESERVED, 16, 16, {4, 1, 16, 16}, {2, 2, 16, 16}, DT_FLOAT};
  TransResult result;
...
TEST_F(UtestFormatTransferFracZHwcn, fracz_to_hwcn_fp32_success_gt_cube) {
  ...
  TransArgs args{
      reinterpret_cast<uint8_t *>(data_4d), src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED,
      FORMAT_RESERVED, 16, 16, {8, 2, 16, 16}, {2, 2, 17, 17}, DT_FLOAT};
  TransResult result;
...
TEST_F(UtestFormatTransferFracZHwcn, uint8_1c_2n_padcn) {
  ...
  const Format dst_format = static_cast<Format>(GetFormatFromSubAndC0(FORMAT_HWCN, FORMAT_RESERVED, 6));
  TransArgs args{
      reinterpret_cast<uint8_t *>(data), src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED,
      FORMAT_RESERVED, 32, 32, std::vector<int64_t>({9, 2, 16, 32}),
...
TEST_F(UtestFormatTransferFracZHwcn, fp16_1c_1n_pad_cn) {
  ...
  TransArgs args{
      reinterpret_cast<uint8_t *>(data), src_format, dst_format, FORMAT_FRACTAL_Z, FORMAT_HWCN, FORMAT_RESERVED,
      FORMAT_RESERVED, 16, 16, std::vector<int64_t>({64, 1, 16, 16}),
