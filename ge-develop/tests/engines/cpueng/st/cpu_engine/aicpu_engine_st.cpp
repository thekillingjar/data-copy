...
TEST(AicpuEngine, Testfloat8_e4m3fn)
{
    ...
    std::cout << "DataType::DT_FLOAT8_E4M3FN" << DataType::DT_FLOAT8_E4M3FN << std::endl;
    string elem;
...
TEST(AicpuEngine, Testfloat8_e5m2)
{
    ...
    string elem;
    std::cout << "DataType::DT_FLOAT8_E5M2" << DataType::DT_FLOAT8_E5M2 << std::endl;
...
TEST(AicpuEngine, Testfloat8_e8m0)
{
    ...
    std::cout << "DataType::DT_FLOAT8_E8M0" << DataType::DT_FLOAT8_E8M0 << std::endl;
    string elem;
