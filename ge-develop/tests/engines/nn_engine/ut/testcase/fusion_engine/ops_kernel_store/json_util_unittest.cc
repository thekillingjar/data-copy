...
{
    std::string filename = GetCodeDir() + "/tests/engines/nn_engine/ut/testcase/fusion_engine/ops_kernel_store/fe_config/cce_custom_opinfo/cce_custom_opinfo.json";
    string ret = RealPath(filename);
...
{
    std::string filename = GetCodeDir() + "/tests/engines/nn_engine/ut/testcase/fusion_engine/ops_kernel_store/fe_config/opinfo_not_exist.json";
    json j;
    Status ret = ReadJsonFile(filename, j);
