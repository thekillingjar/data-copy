  ...
  protected:
    ...
    void SetUp() {
        ...
        Configuration::Instance(
                fe::AI_CORE_NAME).ops_store_info_vector_ = (store_info);
    ...
    static NodePtr CreateConstNode(string name, GeTensorDescPtr out_desc_ptr,
    ...
    static NodePtr CreateOtherNode(string name, GeTensorDescPtr tensor_desc_ptr,
                                   ComputeGraphPtr graph) {
    ...
    static NodePtr CreateBiasAddNode(string name, GeTensorDescPtr tensor_desc_ptr,
                                     ComputeGraphPtr graph) {
    ...
    static NodePtr CreateMatMulNode(string name, GeTensorDescPtr tensor_desc_ptr,
                                    ComputeGraphPtr graph) {
    ...
    static ComputeGraphPtr CreateTestGraph(bool fusion_flag) {
        ...
        */
        ...
        NodePtr node_bias_add_fusion = CreateBiasAddNode("test/BiasAdd_fusion",
                                                      general_ge_tensor_desc,
                                                      graph);
        NodePtr node_bias_add0 = CreateBiasAddNode("test/BiasAdd0",
                                                 general_ge_tensor_desc, graph);
