...
class STEST_TbeSingleOpInfoAssembler : public testing::Test
{
protected:
  void SetUp() {
...
TEST_F(STEST_TbeSingleOpInfoAssembler, Test_JudgeShapeToSetFlag){
  ...
  Status ret = single_tbe.tbe_info_assembler_ptr_->JudgeShapeToSetFlag(op_desc_ptr, true, op_info, flag);
  EXPECT_EQ(fe::SUCCESS, ret);

}

TEST_F(STEST_TbeSingleOpInfoAssembler, Test_Feed_Flag_Int64_To_Tbe_Op_Info){
  std::string op_name    = "conv";
  std::string op_module   = "";
  std::string op_type     = "tbe";
  std::string core_type   = "AIcoreEngine";
...
TEST_F(STEST_TbeSingleOpInfoAssembler, Test_ParseInputInfoFromOp_1){
  std::string op_name    = "conv";
  std::string op_module   = "";
  std::string op_type     = "tbe";
  std::string core_type   = "AIcoreEngine";
...
TEST_F(STEST_TbeSingleOpInfoAssembler, Test_Parse_Input_Info_From_Op_2){
  std::string op_name    = "conv";
  std::string op_module   = "";
  std::string op_type     = "tbe";
  std::string core_type   = "AIcoreEngine";
...
TEST_F(STEST_TbeSingleOpInfoAssembler, Test_Parse_Input_Info_From_Op_3){
  std::string op_name    = "conv";
  std::string op_module   = "";
  std::string op_type     = "tbe";
  std::string core_type   = "AIcoreEngine";
...
TEST_F(STEST_TbeSingleOpInfoAssembler, Test_Parse_Input_Info_From_Op_4){
  std::string op_name    = "conv";
  std::string op_module   = "";
  std::string op_type     = "tbe";
  std::string core_type   = "AIcoreEngine";
...
TEST_F(STEST_TbeSingleOpInfoAssembler, feed_attrs_to_single_tbeopinfo_1) {
...
TEST_F(STEST_TbeSingleOpInfoAssembler, feed_attrs_to_single_tbeopinfo_2) {
  OpDescPtr op_desc_ptr = std::make_shared<OpDesc>("op", "Op");
...
TEST_F(STEST_TbeSingleOpInfoAssembler, feed_attrs_to_single_tbeopinfo_3) {
  OpDescPtr op_desc_ptr = std::make_shared<OpDesc>("op", "Op");
  std::string op_attr_list = "attr1:str;attr2:int";
  ge::AttrUtils::SetStr(op_desc_ptr, ge::ATTR_NAME_UNREGST_ATTRLIST, op_attr_list);
