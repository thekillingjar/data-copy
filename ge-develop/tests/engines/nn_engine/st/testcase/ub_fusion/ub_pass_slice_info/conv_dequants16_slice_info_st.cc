...
class CONV_DEQUANTS16_SLICE_INFO_UNITTEST : public testing::Test {
 public:
 protected:
  virtual void SetUp() {
...
TEST_F(CONV_DEQUANTS16_SLICE_INFO_UNITTEST, modify_slice_info_by_pattern_suc) {
  ...
  size_t input_size = 1;
  bool is_head_fusion;
  Status ret = conv_dequant_s16_slice_info_ptr->ModifySliceInfoByPattern(fusion_node, fusion_nodes, op_calc_info,
