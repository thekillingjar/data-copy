...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_1) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_2) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_aipp) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_write_select) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_strided_write) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_dequant_1) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_dequant_2) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_dequant_3) {
  vector<ge::NodePtr> fusin_nodes;
  ComputeGraphPtr graph = CreateGraphWithTwoInput("AscendDequant", "dequant", true, fusin_nodes);
  EXPECT_NE(graph, nullptr);
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_requant) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_elemwise_1) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_elemwise_2) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_Pool2d) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_dequant_s16) {
  vector<ge::NodePtr> fusin_nodes;
...
TEST_F(UbPassSliceInfoManagerST, set_slice_info_for_fusion_nodes_requant_s16) {
  vector<ge::NodePtr> fusin_nodes;
