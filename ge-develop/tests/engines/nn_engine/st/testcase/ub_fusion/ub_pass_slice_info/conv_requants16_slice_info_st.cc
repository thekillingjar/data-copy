...
class CONV_REQUANTS16_SLICE_INFO_STEST : public testing::Test {
 public:
 protected:
  virtual void SetUp() {
...
TEST_F(CONV_REQUANTS16_SLICE_INFO_STEST, modify_slice_info_by_pattern_suc) {
...
TEST_F(CONV_REQUANTS16_SLICE_INFO_STEST, set_output_slice_info_for_requants16_suc) {
  ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
  BuildGraph_1(graph);
  ge::NodePtr fusion_node = graph->FindNode("dequant");
  OpCalcInfo op_calc_info;
