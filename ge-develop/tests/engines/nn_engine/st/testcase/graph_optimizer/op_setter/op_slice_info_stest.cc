...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_elem_9) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_dynamic_1) {
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_dynamic_2) {
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_dynamic_3) {
  OpDescPtr op_desc_ptr = std::make_shared<OpDesc>("add", "Add");
  vector<int64_t> dim(4, 1);
  GeShape shape(dim);
  GeTensorDesc tensor_desc(shape, FORMAT_NCHW, DT_FLOAT);
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_dynamic_4) {
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_dynamic_5) {
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_dynamic_6) {
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_dynamic_7) {
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_elemwisebroadcast_case1) {
  OpDescPtr op_desc_ptr = std::make_shared<OpDesc>("add", "Add");
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_elemwisebroadcast_case2) {
  OpDescPtr op_desc_ptr = std::make_shared<OpDesc>("add", "Add");
  vector<int64_t> dim = {1, 2, 3, 4};
  GeShape shape(dim);
  GeTensorDesc tensor_desc(shape, FORMAT_NCHW, DT_FLOAT);
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_elemwisebroadcast_case3) {
  OpDescPtr op_desc_ptr = std::make_shared<OpDesc>("add", "Add");
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_op_slice_info_elemwisebroadcast_fail1) {
  OpDescPtr op_desc_ptr = std::make_shared<OpDesc>("add", "Add");
  vector<int64_t> dim = {4};
  GeShape shape(dim);
  GeTensorDesc tensor_desc(shape, FORMAT_NCHW, DT_FLOAT);
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_elemwise_slice_info_test) {
...
TEST_F(STEST_OP_SLICE_INFO_SETTER, set_elemwise_slice_info_test1) {
  ge::OpDescPtr op_desc_ptr = std::make_shared<OpDesc>("add", "Add");
  vector<int64_t> dim = {4};
  GeShape shape(dim);
