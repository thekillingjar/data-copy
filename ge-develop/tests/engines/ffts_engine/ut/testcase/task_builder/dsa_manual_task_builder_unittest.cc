...
class FFTSPlusDsaTaskBuilderTest : public testing::Test
{
private:
...
TEST_F(FFTSPlusDsaTaskBuilderTest, GenContextDef_DSARandomNormal)
{
...
TEST_F(FFTSPlusDsaTaskBuilderTest, GenContextDef_DSARandomTruncatedNormal)
{
...
TEST_F(FFTSPlusDsaTaskBuilderTest, GenContextDef_DSARandomUniform)
{
...
TEST_F(FFTSPlusDsaTaskBuilderTest, GenContextDef_DSARandomUniformconstant0)
{
...
TEST_F(FFTSPlusDsaTaskBuilderTest, GenContextDef_DSARandomUniformconstant1)
{
...
TEST_F(FFTSPlusDsaTaskBuilderTest, GenContextDef_DSARandomUniformconstantall)
{
...
TEST_F(FFTSPlusDsaTaskBuilderTest, GenContextDef_DSAGenBitMask)
{
...
TEST_F(FFTSPlusDsaTaskBuilderTest, GenContextDef_DSAGetConstInputValue)
{
	auto node = CreateDSARandomUniformconstant1Node();
	std::string value;
...
TEST_F(FFTSPlusDsaTaskBuilderTest, GenContextDef_IsConstInput)
{
...
TEST_F(FFTSPlusDsaTaskBuilderTest, ExceptTest)
{
	auto node = CreateDSARandominputconstNode();
	std::string value;
