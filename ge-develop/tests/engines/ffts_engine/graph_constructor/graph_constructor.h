...
class GraphConstructor {
 public:
  ...
  GraphConstructor &Attr(string node_name, const std::string &name, int32_t value);
  GraphConstructor &Attr(string node_name, const std::string &name, uint32_t value);
  GraphConstructor &Attr(string node_name, const std::string &name, const std::vector<int32_t> &value);
  GraphConstructor &Attr(string node_name, const std::string &name, const std::vector<uint32_t> &value);
  GraphConstructor &Attr(string node_name, const std::string &name, const std::vector<int64_t> &value);
  GraphConstructor &Attr(string node_name, const std::string &name, const char *value);
