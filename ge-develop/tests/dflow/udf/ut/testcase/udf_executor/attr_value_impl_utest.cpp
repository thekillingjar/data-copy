...
namespace FlowFunc {
class AttrValueImplUTest : public testing::Test {
 protected:
  virtual void SetUp() {}
...
TEST_F(AttrValueImplUTest, get_float_success) {
...
TEST_F(AttrValueImplUTest, get_float_failed) {
  ff::udf::AttrValue proto_attr;
  proto_attr.set_i(1);
  AttrValueImpl impl(proto_attr);
  float float_val;
...
TEST_F(AttrValueImplUTest, get_int_success) {
  ff::udf::AttrValue proto_attr;
...
TEST_F(AttrValueImplUTest, get_int_failed) {
  ff::udf::AttrValue proto_attr;
  proto_attr.set_f(1.0f);
  AttrValueImpl impl(proto_attr);
  int64_t int_val;
...
TEST_F(AttrValueImplUTest, get_bool_success) {
  ff::udf::AttrValue proto_attr;
...
TEST_F(AttrValueImplUTest, get_bool_failed) {
  ff::udf::AttrValue proto_attr;
  proto_attr.set_f(1.0f);
  AttrValueImpl impl(proto_attr);
  bool bool_val;
...
TEST_F(AttrValueImplUTest, get_string_success) {
  ff::udf::AttrValue proto_attr;
...
TEST_F(AttrValueImplUTest, get_string_with_len_success) {
  ff::udf::AttrValue proto_attr;
  std::string with_terminal_str("abc\0def", 7);
  AscendString with_terminal("abc\0def", 7);
  proto_attr.set_s(with_terminal_str);
  AttrValueImpl impl(proto_attr);
  AscendString str_val;
  auto ret = impl.GetVal(str_val);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
  EXPECT_EQ(str_val, with_terminal);
  EXPECT_EQ(str_val.GetLength(), 7);
}

TEST_F(AttrValueImplUTest, get_string_failed) {
  ff::udf::AttrValue proto_attr;
  proto_attr.set_f(1.0f);
  AttrValueImpl impl(proto_attr);
  AscendString str_val;
...
TEST_F(AttrValueImplUTest, get_type_success) {
  ff::udf::AttrValue proto_attr;
...
TEST_F(AttrValueImplUTest, get_type_failed) {
  ff::udf::AttrValue proto_attr;
  proto_attr.set_f(1.0f);
  AttrValueImpl impl(proto_attr);
  TensorDataType type_val;
...
TEST_F(AttrValueImplUTest, get_type_list_success) {
  ff::udf::AttrValue proto_attr;
...
TEST_F(AttrValueImplUTest, get_type_list_failed) {
  ff::udf::AttrValue proto_attr;
  AttrValueImpl impl(proto_attr);
  std::vector<TensorDataType> list_type_val;
  auto ret = impl.GetVal(list_type_val);
...
TEST_F(AttrValueImplUTest, get_string_list_success) {
...
TEST_F(AttrValueImplUTest, get_string_list_failed) {
  ff::udf::AttrValue proto_attr;
  AttrValueImpl impl(proto_attr);
  std::vector<AscendString> list_str_val;
  auto ret = impl.GetVal(list_str_val);
...
TEST_F(AttrValueImplUTest, get_float_list_success) {
...
TEST_F(AttrValueImplUTest, get_float_list_failed) {
  ff::udf::AttrValue proto_attr;
  AttrValueImpl impl(proto_attr);
  std::vector<float> list_float_val;
  auto ret = impl.GetVal(list_float_val);
...
TEST_F(AttrValueImplUTest, get_int_list_success) {
...
TEST_F(AttrValueImplUTest, get_int_list_failed) {
  ff::udf::AttrValue proto_attr;
  AttrValueImpl impl(proto_attr);
  std::vector<int64_t> list_int_val;
  auto ret = impl.GetVal(list_int_val);
...
TEST_F(AttrValueImplUTest, get_bool_list_success) {
...
TEST_F(AttrValueImplUTest, get_bool_list_failed) {
  ff::udf::AttrValue proto_attr;
  AttrValueImpl impl(proto_attr);
  std::vector<bool> list_bool_val;
  auto ret = impl.GetVal(list_bool_val);
...
TEST_F(AttrValueImplUTest, get_list_list_int_success) {
...
TEST_F(AttrValueImplUTest, get_list_list_int_failed) {
  ff::udf::AttrValue proto_attr;
  AttrValueImpl impl(proto_attr);
  std::vector<std::vector<int64_t>> list_list_val;
  auto ret = impl.GetVal(list_list_val);
