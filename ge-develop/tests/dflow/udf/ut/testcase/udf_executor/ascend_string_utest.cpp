...
TEST_F(AscendStringUTest, string_equal) {
...
TEST_F(AscendStringUTest, string_not_equal) {
  AscendString src_str("abc");
...
TEST_F(AscendStringUTest, string_large_than) {
  AscendString src_str("abc");
...
TEST_F(AscendStringUTest, string_large_equal_than) {
  AscendString src_str("abc");
  AscendString target_str("abc");
  AscendString empty_str1;
  AscendString empty_str2;
...
TEST_F(AscendStringUTest, with_length) {
...
TEST_F(AscendStringUTest, null_size) {
  AscendString strcmp1(nullptr, 1);
  ASSERT_EQ(strcmp1.GetLength(), 0);
}

TEST_F(AscendStringUTest, with_terminal) {
