...
int halMbufGetBuffSizeStub(Mbuf *mbuf, uint64_t *totalSize) {
  MbufImpl *mbuf_impl = reinterpret_cast<MbufImpl *>(mbuf);
...
HcclResult HcclRawBindSuc(HcclConn conn, HcclAddr *bindAddr) {
  return HCCL_SUCCESS;
}

HcclResult HcclRawBindFail(HcclConn conn, HcclAddr *bindAddr) {
  return HCCL_E_INTERNAL;
}

HcclResult HcclRawConnectFail(HcclConn conn, HcclAddr *connectAddr) {
  return HCCL_E_INTERNAL;
}
...
HcclResult HcclRawCloseFail(HcclConn conn) {
  return HCCL_E_INTERNAL;
}
...
HcclResult HcclRawConnectStub(HcclConn conn, HcclAddr *connectAddr) {
  return HCCL_SUCCESS;
}
...
HcclResult HcclRawListenStub(HcclConn conn, int backLog) {
  return HCCL_SUCCESS;
}
...
HcclResult HcclRawImrecvScatterStub(void *buf[], int counts[], int bufCount, HcclDataType dataType, HcclMessage *msg,
                                    HcclRequest *request) {
...
class LlmServiceFlowFuncSTest : public testing::Test {
 public:
  static void SetUpTestCase() {
    sync_req_info_data.resize(sizeof(SyncKvReqInfo) + 2 * sizeof(SyncBufferInfo));
 ...
 protected:
  virtual void SetUp() {
    ...
    MOCKER(HcclRawAccept).reset();
    void *func_raw_accept_func = reinterpret_cast<void *>(&HcclRawAcceptSuc);
    HcclSoManager::GetInstance()->func_map_.emplace(kHcclRawAcceptFuncName, func_raw_accept_func);
  ...
  virtual void TearDown() {
    ...
    CacheManager::GetInstance().enabled_ = false;
    CacheManager::GetInstance().cache_id_to_entry_.clear();
    CacheManager::GetInstance().cache_index_to_id_.clear();
...
TEST_F(LlmServiceFlowFuncSTest, init_success) {
...
TEST_F(LlmServiceFlowFuncSTest, init_failed) {
  LlmServiceFlowFunc llm_service_flow_func;
...
TEST_F(LlmServiceFlowFuncSTest, init_group_query_failed) {
...
TEST_F(LlmServiceFlowFuncSTest, init_group_size_over_one) {
...
TEST_F(LlmServiceFlowFuncSTest, init_load_so_failed) {
...
TEST_F(LlmServiceFlowFuncSTest, test_pull_blocks_scatter) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, update_link_with_one_cluster) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, update_link_with_multi_cluster) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, copy_cache_not_exist) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, copy_cache_param_invalid) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, sync_kv_cache_link_not_exist) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, sync_kv_cache_success) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
  ...
  *req_info = PullKvReqInfo{};
  ...
  sync_req_info->buffer_count_per_layer = 1U;
  sync_req_info->tensor_index_count = 0;
  sync_req_info->transfer_infos[0].buffer_info.block_index = 0U;
...
TEST_F(LlmServiceFlowFuncSTest, remove_cache_index_success) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_server_sync_kv_success) {
  LlmServiceFlowFunc llm_service_flow_func;
...
TEST_F(LlmServiceFlowFuncSTest, test_server_sync_kv_by_cache_id_success) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(true);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
  ...
  EXPECT_EQ(LlmCommEntityMgr::GetInstance().server_entity_map_.size(), 0);
  EXPECT_EQ(DeallocateCache(run_context, out_msg, llm_service_flow_func, cache_id), FsmStatus::kFsmSuccess);
  sync_kv_req_info->cache_id = -1L;
}

TEST_F(LlmServiceFlowFuncSTest, test_copy_cache_success) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_prompt_send_blocks) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(true);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_prompt_send_blocks_by_cache_id_failed) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(true);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_copy_blocks_success) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_get_cache_success) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, allocate_cache_failed) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, switch_role_success) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_pull_blocks_validate) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_prompt_send_blocks_validate_req_size) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(true);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_prompt_validate_not_blocks_req_param) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(true);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_copy_blocks_failed) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_copy_large_data) {
...
TEST_F(LlmServiceFlowFuncSTest, test_force_unlink) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_force_unlink_fail) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, push_kv_cache_success) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_receive_push_kv_success) {
  LlmServiceFlowFunc llm_service_flow_func;
...
TEST_F(LlmServiceFlowFuncSTest, transfer_blocks_validate_block_len) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_receive_push_kv_egain) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(false);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, transfer_blocks_scatter) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, transfer_blocks_no_prompt_block_len) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_pull_blocks_no_prompt_block_len) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_server_accept_failed) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(true);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_receive_push_kv_probe_msg_invalid) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(false);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_server_sync_kv_probe_msg_invalid) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(true);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, update_link_over_limit) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, update_link_req_invalid) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_pull_with_tensor_indices) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_server_sync_kv_with_tensor_indices_success) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(true);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_pull_with_offset) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_server_sync_kv_with_offset_success) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(true);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, sync_kv_probe_meta_size_invalid) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_server_accept_force_link) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(true);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_server_handle_check_link_suc) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(true);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, check_link_suc) {
  LlmServiceFlowFunc llm_service_flow_func;
  // init
  std::shared_ptr<FlowFuncParams> params = CreateAttrs();
  auto ret = llm_service_flow_func.Init(params);
...
TEST_F(LlmServiceFlowFuncSTest, test_receive_push_kv_validate_key_mem_fail) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(false);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
...
TEST_F(LlmServiceFlowFuncSTest, test_receive_with_cacheid_push_kv_success) {
  LlmServiceFlowFunc llm_service_flow_func;
  std::shared_ptr<FlowFuncParams> params = CreateAttrs(false);
  auto ret = llm_service_flow_func.Init(params);
  EXPECT_EQ(ret, FLOW_FUNC_SUCCESS);
