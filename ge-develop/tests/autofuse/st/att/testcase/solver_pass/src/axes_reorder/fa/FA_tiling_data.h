...
#ifndef ATT_TILING_DATA_FA_H_
#define ATT_TILING_DATA_FA_H_
#include <stdint.h>
#include <vector>
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(FA, TilingData)
bool GetTiling(TilingData &tiling_data, int32_t tilingCaseId = -1);
} // namespace optiling
#endif
