...
struct TilingDataCopy {
  ...
  void set_MATMUL_OUTPUT1(uint32_t val) { MATMUL_OUTPUT1 = val; }
  uint32_t get_MATMUL_OUTPUT1() { return MATMUL_OUTPUT1; }
  uint32_t Q1;
  void set_Q1(uint32_t val) { Q1 = val; }
  uint32_t get_Q1() { return Q1; }
  uint32_t basek_loop_num;
  void set_basek_loop_num(uint32_t val) { basek_loop_num = val; }
  uint32_t get_basek_loop_num() { return basek_loop_num; }
  uint32_t basek_size;
  void set_basek_size(uint32_t val) { basek_size = val; }
  uint32_t get_basek_size() { return basek_size; }
  uint32_t basek_tail_size;
  void set_basek_tail_size(uint32_t val) { basek_tail_size = val; }
  uint32_t get_basek_tail_size() { return basek_tail_size; }
  uint32_t basem_loop_num;
  void set_basem_loop_num(uint32_t val) { basem_loop_num = val; }
  uint32_t get_basem_loop_num() { return basem_loop_num; }
  uint32_t basem_size;
  void set_basem_size(uint32_t val) { basem_size = val; }
  uint32_t get_basem_size() { return basem_size; }
  uint32_t basem_tail_size;
  void set_basem_tail_size(uint32_t val) { basem_tail_size = val; }
  uint32_t get_basem_tail_size() { return basem_tail_size; }
  uint32_t basen_loop_num;
  void set_basen_loop_num(uint32_t val) { basen_loop_num = val; }
  uint32_t get_basen_loop_num() { return basen_loop_num; }
  uint32_t basen_size;
  void set_basen_size(uint32_t val) { basen_size = val; }
  uint32_t get_basen_size() { return basen_size; }
  uint32_t basen_tail_size;
  void set_basen_tail_size(uint32_t val) { basen_tail_size = val; }
  uint32_t get_basen_tail_size() { return basen_tail_size; }
  uint32_t block_dim;
  ...
  uint32_t k_size;
  void set_k_size(uint32_t val) { k_size = val; }
  uint32_t get_k_size() { return k_size; }
  uint32_t l0a_size;
  void set_l0a_size(uint32_t val) { l0a_size = val; }
  uint32_t get_l0a_size() { return l0a_size; }
  uint32_t l0b_size;
  void set_l0b_size(uint32_t val) { l0b_size = val; }
  uint32_t get_l0b_size() { return l0b_size; }
  uint32_t l0c_size;
  void set_l0c_size(uint32_t val) { l0c_size = val; }
  uint32_t get_l0c_size() { return l0c_size; }
  uint32_t l1_size;
  void set_l1_size(uint32_t val) { l1_size = val; }
  uint32_t get_l1_size() { return l1_size; }
  uint32_t l2_size;
  void set_l2_size(uint32_t val) { l2_size = val; }
  uint32_t get_l2_size() { return l2_size; }
  uint32_t m_size;
  void set_m_size(uint32_t val) { m_size = val; }
  uint32_t get_m_size() { return m_size; }
  uint32_t n_size;
  void set_n_size(uint32_t val) { n_size = val; }
  uint32_t get_n_size() { return n_size; }
  ...
  uint32_t stepka_loop_num;
  void set_stepka_loop_num(uint32_t val) { stepka_loop_num = val; }
  uint32_t get_stepka_loop_num() { return stepka_loop_num; }
  uint32_t stepka_size;
  void set_stepka_size(uint32_t val) { stepka_size = val; }
  uint32_t get_stepka_size() { return stepka_size; }
  uint32_t stepka_tail_size;
  void set_stepka_tail_size(uint32_t val) { stepka_tail_size = val; }
  uint32_t get_stepka_tail_size() { return stepka_tail_size; }
  uint32_t stepka_tail_tile_stepkb_loop_num;
  void set_stepka_tail_tile_stepkb_loop_num(uint32_t val) { stepka_tail_tile_stepkb_loop_num = val; }
  uint32_t get_stepka_tail_tile_stepkb_loop_num() { return stepka_tail_tile_stepkb_loop_num; }
  uint32_t stepka_tail_tile_stepkb_tail_size;
  void set_stepka_tail_tile_stepkb_tail_size(uint32_t val) { stepka_tail_tile_stepkb_tail_size = val; }
  uint32_t get_stepka_tail_tile_stepkb_tail_size() { return stepka_tail_tile_stepkb_tail_size; }
  uint32_t stepkb_loop_num;
  void set_stepkb_loop_num(uint32_t val) { stepkb_loop_num = val; }
  uint32_t get_stepkb_loop_num() { return stepkb_loop_num; }
  uint32_t stepkb_size;
  void set_stepkb_size(uint32_t val) { stepkb_size = val; }
  uint32_t get_stepkb_size() { return stepkb_size; }
  uint32_t stepkb_tail_size;
  void set_stepkb_tail_size(uint32_t val) { stepkb_tail_size = val; }
  uint32_t get_stepkb_tail_size() { return stepkb_tail_size; }
  uint32_t stepkb_tail_tile_basek_loop_num;
  void set_stepkb_tail_tile_basek_loop_num(uint32_t val) { stepkb_tail_tile_basek_loop_num = val; }
  uint32_t get_stepkb_tail_tile_basek_loop_num() { return stepkb_tail_tile_basek_loop_num; }
  uint32_t stepkb_tail_tile_basek_tail_size;
  void set_stepkb_tail_tile_basek_tail_size(uint32_t val) { stepkb_tail_tile_basek_tail_size = val; }
  uint32_t get_stepkb_tail_tile_basek_tail_size() { return stepkb_tail_tile_basek_tail_size; }
  uint32_t tilem_loop_num;
  void set_tilem_loop_num(uint32_t val) { tilem_loop_num = val; }
  uint32_t get_tilem_loop_num() { return tilem_loop_num; }
  uint32_t tilem_size;
  void set_tilem_size(uint32_t val) { tilem_size = val; }
  uint32_t get_tilem_size() { return tilem_size; }
  uint32_t tilem_tail_size;
  void set_tilem_tail_size(uint32_t val) { tilem_tail_size = val; }
  uint32_t get_tilem_tail_size() { return tilem_tail_size; }
  uint32_t tilem_tail_tile_basem_loop_num;
  void set_tilem_tail_tile_basem_loop_num(uint32_t val) { tilem_tail_tile_basem_loop_num = val; }
  uint32_t get_tilem_tail_tile_basem_loop_num() { return tilem_tail_tile_basem_loop_num; }
  uint32_t tilem_tail_tile_basem_tail_size;
  void set_tilem_tail_tile_basem_tail_size(uint32_t val) { tilem_tail_tile_basem_tail_size = val; }
  uint32_t get_tilem_tail_tile_basem_tail_size() { return tilem_tail_tile_basem_tail_size; }
  uint32_t tilen_loop_num;
  void set_tilen_loop_num(uint32_t val) { tilen_loop_num = val; }
  uint32_t get_tilen_loop_num() { return tilen_loop_num; }
  uint32_t tilen_size;
  void set_tilen_size(uint32_t val) { tilen_size = val; }
  uint32_t get_tilen_size() { return tilen_size; }
  uint32_t tilen_tail_size;
  void set_tilen_tail_size(uint32_t val) { tilen_tail_size = val; }
  uint32_t get_tilen_tail_size() { return tilen_tail_size; }
  uint32_t tilen_tail_tile_basen_loop_num;
  void set_tilen_tail_tile_basen_loop_num(uint32_t val) { tilen_tail_tile_basen_loop_num = val; }
  uint32_t get_tilen_tail_tile_basen_loop_num() { return tilen_tail_tile_basen_loop_num; }
  uint32_t tilen_tail_tile_basen_tail_size;
  void set_tilen_tail_tile_basen_tail_size(uint32_t val) { tilen_tail_tile_basen_tail_size = val; }
  uint32_t get_tilen_tail_tile_basen_tail_size() { return tilen_tail_tile_basen_tail_size; }
  uint32_t tiling_key;
...
class TilingCaseImpl {
 public:
  ...
  virtual void GetTilingData(TilingDataCopy &from_tiling, MMTilingData &to_tiling) {};
  virtual void SetTilingData(MMTilingData &from_tiling, TilingDataCopy &to_tiling) {};
 protected:
...
double GeneralSolvercase1::GetObj(uint64_t* vars)
{
    ...
    double AIC_MAC = (Max(1, (tilem_size * tilen_size / (basem_size * basen_size * block_dim))) * ceiling(((double)(1)/(double)(16) * basek_size)) * ceiling(((double)(1)/(double)(16) * basem_size)) * ceiling(((double)(1)/(double)(16) * basen_size)) * k_size * m_size * n_size / (basek_size * tilem_size * tilen_size));
    OP_LOGD(OP_NAME, "AIC_MAC = %f", AIC_MAC);
    double AIC_MTE1 = ((((double)(1)/(double)(128) * basek_size * basen_size) + ((double)(1)/(double)(256) * basek_size * basem_size) + 52) * Max(1, (tilem_size * tilen_size / (basem_size * basen_size * block_dim))) * k_size * m_size * n_size / (basek_size * tilem_size * tilen_size));
    OP_LOGD(OP_NAME, "AIC_MTE1 = %f", AIC_MTE1);
    ...
    return Max(Max(Max(AIC_FIXPIPE, AIC_MAC), AIC_MTE1), AIC_MTE2);
}
/*
...
double GeneralSolvercase1::GetSmoothObj(uint64_t* vars)
{
    ...
    double stepkb_size_base = static_cast<double>(vars[stepkb_size_base_idx]);
    double AIC_FIXPIPE = ((double)(1)/(double)(8) * Max(1, (tilem_size * tilen_size / (basem_size * basen_size * block_dim))) * basem_size * basen_size * m_size * n_size / (tilem_size * tilen_size));
    double AIC_MAC = (Max(1, (tilem_size * tilen_size / (basem_size * basen_size * block_dim))) * (((double)(1)/(double)(16) * basek_size)) * (((double)(1)/(double)(16) * basem_size)) * (((double)(1)/(double)(16) * basen_size)) * k_size * m_size * n_size / (basek_size * tilem_size * tilen_size));
    double AIC_MTE1 = ((((double)(1)/(double)(128) * basek_size * basen_size) + ((double)(1)/(double)(256) * basek_size * basem_size) + 52) * Max(1, (tilem_size * tilen_size / (basem_size * basen_size * block_dim))) * k_size * m_size * n_size / (basek_size * tilem_size * tilen_size));
    double AIC_MTE2 = ((((((double)(1)/(double)(16) * Max(1, (256 / (basen_size))) * Max(16, basek_size) * basen_size * pow(2, stepkb_size_base)) + 210) * Max(256, (Max(16, basek_size) * pow(2, stepkb_size_base))) * pow(2, (-1 * stepkb_size_base)) * stepka_size_div_align / (Max(16, basek_size))) + ((double)(1)/(double)(16) * Max(1, (256 / (Max(256, (Max(16, basek_size) * pow(2, stepkb_size_base))) * stepka_size_div_align))) * Max(256, (Max(16, basek_size) * pow(2, stepkb_size_base))) * basem_size * stepka_size_div_align) + 210) * Max(1, (tilem_size * tilen_size / (basem_size * basen_size * block_dim))) * k_size * m_size * n_size / (Max(256, (Max(16, basek_size) * pow(2, stepkb_size_base))) * stepka_size_div_align * tilem_size * tilen_size));
    return Max(Max(Max(AIC_FIXPIPE, AIC_MAC), AIC_MTE1), AIC_MTE2);
}
...
bool GeneralSolvercase1::Init(const SolverInput &input) {
...
class TilingCase1Impl : public TilingCaseImpl {
 ...
 protected:
  void GetTilingData(TilingDataCopy &from_tiling, MMTilingData &to_tiling) {
    to_tiling.set_block_dim(from_tiling.get_block_dim());
    to_tiling.set_k_size(from_tiling.get_k_size());
    to_tiling.set_m_size(from_tiling.get_m_size());
    to_tiling.set_n_size(from_tiling.get_n_size());
    to_tiling.set_basek_size(from_tiling.get_basek_size());
    to_tiling.set_basem_size(from_tiling.get_basem_size());
    to_tiling.set_basen_size(from_tiling.get_basen_size());
    to_tiling.set_stepka_size(from_tiling.get_stepka_size());
    to_tiling.set_stepkb_size(from_tiling.get_stepkb_size());
    to_tiling.set_tilem_size(from_tiling.get_tilem_size());
    to_tiling.set_tilen_size(from_tiling.get_tilen_size());
    to_tiling.set_block_dim(from_tiling.get_block_dim());
    to_tiling.set_MATMUL_OUTPUT1(from_tiling.get_MATMUL_OUTPUT1());
    to_tiling.set_Q1(from_tiling.get_Q1());
    to_tiling.set_basek_loop_num(from_tiling.get_basek_loop_num());
    to_tiling.set_basek_tail_size(from_tiling.get_basek_tail_size());
    to_tiling.set_basem_loop_num(from_tiling.get_basem_loop_num());
    to_tiling.set_basem_tail_size(from_tiling.get_basem_tail_size());
    to_tiling.set_basen_loop_num(from_tiling.get_basen_loop_num());
    to_tiling.set_basen_tail_size(from_tiling.get_basen_tail_size());
    ...
    to_tiling.set_stepka_loop_num(from_tiling.get_stepka_loop_num());
    to_tiling.set_stepka_tail_size(from_tiling.get_stepka_tail_size());
    to_tiling.set_stepka_tail_tile_stepkb_loop_num(from_tiling.get_stepka_tail_tile_stepkb_loop_num());
    to_tiling.set_stepka_tail_tile_stepkb_tail_size(from_tiling.get_stepka_tail_tile_stepkb_tail_size());
    to_tiling.set_stepkb_loop_num(from_tiling.get_stepkb_loop_num());
    to_tiling.set_stepkb_tail_size(from_tiling.get_stepkb_tail_size());
    to_tiling.set_stepkb_tail_tile_basek_loop_num(from_tiling.get_stepkb_tail_tile_basek_loop_num());
    to_tiling.set_stepkb_tail_tile_basek_tail_size(from_tiling.get_stepkb_tail_tile_basek_tail_size());
    to_tiling.set_tilem_loop_num(from_tiling.get_tilem_loop_num());
    to_tiling.set_tilem_tail_size(from_tiling.get_tilem_tail_size());
    to_tiling.set_tilem_tail_tile_basem_loop_num(from_tiling.get_tilem_tail_tile_basem_loop_num());
    to_tiling.set_tilem_tail_tile_basem_tail_size(from_tiling.get_tilem_tail_tile_basem_tail_size());
    to_tiling.set_tilen_loop_num(from_tiling.get_tilen_loop_num());
    to_tiling.set_tilen_tail_size(from_tiling.get_tilen_tail_size());
    to_tiling.set_tilen_tail_tile_basen_loop_num(from_tiling.get_tilen_tail_tile_basen_loop_num());
    to_tiling.set_tilen_tail_tile_basen_tail_size(from_tiling.get_tilen_tail_tile_basen_tail_size());
    to_tiling.set_tiling_key(from_tiling.get_tiling_key());

  }
  void SetTilingData(MMTilingData &from_tiling, TilingDataCopy &to_tiling) {
    to_tiling.set_block_dim(from_tiling.get_block_dim());
    to_tiling.set_k_size(from_tiling.get_k_size());
    to_tiling.set_m_size(from_tiling.get_m_size());
    to_tiling.set_n_size(from_tiling.get_n_size());
...
*/
  bool ExecuteL0Solver(MMTilingData& tiling_data) {
    ...
    if (output == nullptr) {
      OP_LOGW(OP_NAME, "output is nullptr");
      return false;
    }
...
*/
  ...
  bool ExecuteGeneralSolver(MMTilingData& tiling_data) {
    ...
    std::shared_ptr<GeneralSolvercase1> solver = std::make_shared<GeneralSolvercase1>(cfg, tiling_data);
    if (solver != nullptr) {
        // 导入通用求解器的输入参数并完成初始化
  ...
  double GetAIC_MTE1(MMTilingData& tiling_data) {
    double basek_size = tiling_data.get_basek_size();
    double basem_size = tiling_data.get_basem_size();
    double basen_size = tiling_data.get_basen_size();
    double block_dim = corenum_;
    double k_size = tiling_data.get_k_size();
    ...
    return ((((double)(1)/(double)(128) * basek_size * basen_size) + ((double)(1)/(double)(256) * basek_size * basem_size) + 52) * Max(1, (tilem_size * tilen_size / (basem_size * basen_size * block_dim))) * k_size * m_size * n_size / (basek_size * tilem_size * tilen_size));
  }
  ...
  double GetAIC_MAC(MMTilingData& tiling_data) {
    ...
    return (Max(1, (tilem_size * tilen_size / (basem_size * basen_size * block_dim))) * ceiling(((double)(1)/(double)(16) * basek_size)) * ceiling(((double)(1)/(double)(16) * basem_size)) * ceiling(((double)(1)/(double)(16) * basen_size)) * k_size * m_size * n_size / (basek_size * tilem_size * tilen_size));
  }
  ...
  void TilingSummary(MMTilingData &tiling_data) {
    ...
    OP_LOGI(OP_NAME, "The value of AIC_MTE1 is %f.", GetAIC_MTE1(tiling_data));
...
bool FindPerfBetterTilingbyCaseId(uint32_t corenum, double &obj, TilingDataCopy &tmp_tiling, MMTilingData &tiling_data, uint32_t tilingCaseId) {
  double cur_obj;
