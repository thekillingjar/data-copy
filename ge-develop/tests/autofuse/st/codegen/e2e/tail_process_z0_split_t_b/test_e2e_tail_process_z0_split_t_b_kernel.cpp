...
class E2E_LoadAbsStore_Code : public testing::Test, public testing::WithParamInterface<std::pair<std::vector<int>, std::vector<int>>> {
};
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_LoadAbsStore_Code,
    ::testing::Values(
                      std::pair<std::vector<int>, std::vector<int>>{{(48*64*4 - 4), 16}, {48, 64, 4}}, // block尾块 尾轴32对齐padding为size32
                      std::pair<std::vector<int>, std::vector<int>>{{(48*64*4 - 4), 36}, {48, 64, 4}}, // block尾块 尾轴32对齐padding为size64
