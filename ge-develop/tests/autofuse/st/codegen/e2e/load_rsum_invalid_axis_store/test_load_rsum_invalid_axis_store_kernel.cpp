...
extern "C" __global__ __aicore__ void load_rsum_invalid_axis_store(GM_ADDR x, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling);
extern "C" void GetTiling(AutofuseTilingData& tiling_data);

class E2E_LoadRsumInvalidAxisStore_Code : public testing::Test,
...
TEST_P(E2E_LoadRsumInvalidAxisStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_rsum_invalid_axis_store, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y, nullptr, (uint8_t *)&tiling_data);
