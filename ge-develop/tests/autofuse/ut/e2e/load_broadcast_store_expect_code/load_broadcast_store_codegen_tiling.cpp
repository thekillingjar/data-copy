...
extern "C" bool CodegenTiling_int64(const std::string &op_name, const std::vector<ge::AscGraph> &graphs,
                              std::map<std::string, std::string> &options,
                              std::map<std::string, std::string> &tiling_func) {
  std::stringstream ss;
...
extern "C" bool CodegenTiling_uint8(const std::string &op_name, const std::vector<ge::AscGraph> &graphs,
                              std::map<std::string, std::string> &options,
                              std::map<std::string, std::string> &tiling_func) {
  std::stringstream ss;
