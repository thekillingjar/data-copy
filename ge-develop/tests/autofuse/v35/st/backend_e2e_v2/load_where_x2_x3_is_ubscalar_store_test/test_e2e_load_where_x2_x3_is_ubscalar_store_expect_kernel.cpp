...
extern "C" __global__ __aicore__ void load_where_store_test(GM_ADDR x1, GM_ADDR y, GM_ADDR workspace, GM_ADDR gm_tiling_data);
...
TEST_P(E2E_LoadWhereX2X3IsUbscalarStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_where_store_test, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)y, nullptr, (uint8_t*)&tiling_data);
