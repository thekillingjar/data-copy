...
extern "C" __global__ __aicore__ void erf_bf16_test(GM_ADDR x0, GM_ADDR output, GM_ADDR workspace, GM_ADDR gm_tiling_data);
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_ErfBf16_Code,
