...
extern "C" __global__ __aicore__ void load_bitwise_not_store_test(GM_ADDR x, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling);
...
class E2E_BackendLoadBitwiseNotStore_Code : public testing::Test, public testing::WithParamInterface<std::vector<int>> {
};
...
TEST_P(E2E_BackendLoadBitwiseNotStore_Code, CalculateCorrect) {
 ...
 ICPU_RUN_KF(load_bitwise_not_store_test, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y, nullptr, (uint8_t*)&tiling_data);
