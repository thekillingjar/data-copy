...
extern "C" __global__ __aicore__ void div_abs_test(GM_ADDR x0, GM_ADDR x1, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling);
...
TEST_P(E2E_BackendDivAbs_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(div_abs_test, tiling_data.block_dim, (uint8_t *)input0, (uint8_t *)input1, (uint8_t *)y, nullptr, (uint8_t*)&tiling_data);
