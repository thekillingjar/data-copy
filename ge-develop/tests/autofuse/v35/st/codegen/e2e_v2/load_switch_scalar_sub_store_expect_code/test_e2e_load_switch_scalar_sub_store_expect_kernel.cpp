...
class E2E_LoadSwitchScalarSubStore_Code : public testing::Test, public testing::WithParamInterface<std::pair<std::vector<int>, std::vector<int>>> {
};
...
TEST_P(E2E_LoadSwitchScalarSubStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_scalar_sub_store, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y, nullptr, (uint8_t*)&tiling_data);
