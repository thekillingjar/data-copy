...
* @li grads: A ND Tensor. Must be one of the following types:
* float16, float32, int32.
* @li x1: A ND Tensor of the same dtype as "grads".
* @li x2: A ND Tensor of the same dtype as "grads". \n
...
* @par Outputs:
* @li y1: A ND Tensor. Has the same dtype as "grads".
* @li y2: A ND Tensor. Has the same dtype as "grads". \n
...
/**
*@brief Returns x1 and x2 greatest common divisor element-wise. Support broadcasting operations.

*@par Inputs:
*Two inputs, including:
* @li x1: A ND Tensor. Must be one of the following types: int32, int16, int64.
* @li x2: A ND Tensor of the same dtype as "x1". \n
...
/**
*@brief Computes x1/x2 element-wise, if x1 == 0, return 0. Support broadcasting operations.
...
* @par Inputs:
* Two inputs, including:
* @li x: A ND Tensor. Must be one of the following types: bfloat16, float16, float32,
* double, complex64, complex128.
* @li y: A ND Tensor. Has the same dtype as "x". \n
...
* @li dy: A tensor with the same dtype of "y".
*
*@attention Constraints:
...
/**
*@brief Computes gradients for Acosh operation. Support broadcasting operations.

*
*@par Inputs:
* @li y: A ND tensor of type float16 or bfloat16 or float32. Support 1D ~ 8D.
* @li dy: A ND tensor with the same dtype of "y".
*
*@attention Constraints:
* "dy" has the same dtype as "y".
*
...
/**
*@brief Confuse broadcast, add and mul. Support broadcasting operations.

*@par Inputs:
*Three inputs, including:
* @li x1: A ND Tensor. Must be one of the following types:int32 float16, float32.
* @li x2: A ND Tensor of the same dtype as "x1".
* @li x3: A ND Tensor of the same dtype as "x1". \n

*@par Outputs:
*@li y: A ND Tensor. Has the same dtype as "x1". \n
...
/**
*@brief Confuse mul+add+add with broadcast. Support broadcasting operations.
...
* @li x2: A ND Tensor of the same dtype as "x1".
* @li x3: A ND Tensor of the same dtype as "x1".
* @li x4: A ND Tensor of the same dtype as "x1". \n
...
*
* @par Inputs:
* @li var: An ND or 5HD tensor. Support 1D~8D. Must be one of the following types: bfloat16, float32, float64, int32, uint8 \n
...
/**
* @brief Computes the gradient for the inverse of "x" with regard its input. Support broadcasting operations.

* @par Inputs:
* @li y: An ND or 5HD tensor. support 1D ~ 8D. Must be one of the following types:
* bfloat16, float, double, complex32, complex64, complex128, float16.
* @li dy: An ND or 5HD tensor. support 1D ~ 8D. Must be one of the following types:
* bfloat16, float, double, complex32, complex64, complex128, float16.
*
* @par Outputs:
...
/**
*@brief Computes gradients for Asinh operation. Support broadcasting operations.
...
/**
*@brief Returns the truth value of abs(x1-x2) < tolerance element-wise. Support broadcasting operations.
...
*@par Attributes:
*@li min: An optional attribute. Type is float. Defaults to "-6.0".
*@li max: An optional attribute. Type is float. Defaults to "6.0".
*@li num_bits: An optional attribute. Type is float. Defaults to "8".
...
*@par Inputs:
*Two inputs, including:
*@li gradients: A ND Tensor of type float32. Shape support 1D ~ 8D. Backpropagated gradients above the FakeQuantWithMinMaxArgs operation.
*@li x: A ND Tensor of type float32. Shape support 1D ~ 8D. Shape should be equal to the shape of "gradients". Has the same dtype and format as "gradients".
...
*@par Inputs:
*Four inputs, including:
*@li gradients: A ND Tensor of type float32. Shape support 1D ~ 8D.
*@li x: A ND Tensor of type float32. Shape support 1D ~ 8D.
* Has the same shape as "gradients".
*@li min: A ND Tensor of type float32. Shape must be 1D.
*@li max: A ND Tensor of type float32. Shape must be 1D. \n

*@par Attributes:
*@li num_bits: An optional attribute specifying the quantization bit width. Type is int. Defaults to "8".
*@li narrow_range: An optional attribute specifying whether to use a narrow range for quantization.
* Type is bool. Defaults to "False". \n

*@par Outputs:
*@li backprops_wrt_x: A ND Tensor. Has the same dtype as input "x".
* Shape support 1D ~ 8D. Has the same shape as input "x".
*@li backprops_wrt_min: A ND Tensor. Has the same dtype as input "min". Shape must be 1D.
*@li backprops_wrt_max: A ND Tensor. Has the same dtype as input "max". Shape must be 1D. \n
...
*@par Attributes:
*@li num_bits: An optional attribute specifying the quantization bit width.
...
*@par Outputs:
*@li backprops_wrt_x: A ND Tensor of type float32. Shape support 1D ~ 8D.
* Has the same dtype and shape as input "x".
*@li backprops_wrt_min: A ND Tensor of type float32.
* Shape must be 1D. Has the same dtype as input "min".
*@li backprops_wrt_max: A ND Tensor of type float32.
...
*x: A ND Tensor of type float16 or float32 in ND format. \n
...
*
*@par Restrictions:
 * Warning: THIS FUNCTION IS DEPRECATED. Please use ArgMaxV2 instead.
*/
REG_OP(ArgMaxD)
    .INPUT(x, TensorType({DT_FLOAT, DT_FLOAT16}))
    .OUTPUT(y, TensorType({DT_INT32}))
...
* @li input_mul3: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_mul2: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_realdiv1: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_mul1: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_mul0: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_realdiv0: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_mul4: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul0_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul1_sub: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul2_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul3_sub1: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul4_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li add2_y: A ND Tensor. Must be one of the following types: float16, float32. \n

*@par Outputs:
*Four outputs, including:
* @li y1: A ND Tensor. Must be one of the following types: float16, float32.
* @li y2: A ND Tensor. Must be one of the following types: float16, float32.
* @li y3: A ND Tensor. Must be one of the following types: float16, float32.
* @li y4: A ND Tensor. Must be one of the following types: float16, float32. \n
...
*Thirteen inputs, including:
* @li input_mul3: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_mul2: A ND Tensor of the same dtype as "input1".
* @li input_realdiv1: A ND Tensor of the same dtype as "input1".
* @li input_mul1: A ND Tensor of the same dtype as "input1".
* @li input_mul0: A ND Tensor of the same dtype as "input1".
* @li input_realdiv0: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_mul4: A ND Tensor of the same dtype as "input1".
* @li mul0_x: A ND Tensor of the same dtype as "input1".
* @li mul1_sub: A ND Tensor of the same dtype as "input1".
* @li mul2_x: A ND Tensor of the same dtype as "input1".
* @li mul3_sub1: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul4_x: A ND Tensor of the same dtype as "input1".
* @li add2_y: A ND Tensor of the same dtype as "input1". \n

*@par Outputs:
*Four outputs, including:
*@li y1: A ND Tensor. Has the same dtype as "input_mul3".
*@li y2: A ND Tensor. Has the same dtype as "input_mul3".
*@li y3: A ND Tensor. Has the same dtype as "input_mul3".
*@li y4: A ND Tensor. Has the same dtype as "input_mul3".
...
* @li input_square: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_mul2: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul2_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul3_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li truediv1_recip: A ND Tensor. Must be one of the following types: float16, float32.
* @li add2_y: A ND Tensor. Must be one of the following types: float16, float32. \n

*@par Outputs:
*Two outputs, including:
* @li y1: A ND Tensor of the same dtype as "input_square".
* @li y2: A ND Tensor of the same dtype as "input_square". \n
...
* @li input_greater1: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_greater_realdiv: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_realdiv: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_mul0: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_mul1: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_sub: A ND Tensor. Must be one of the following types: float16, float32.
* @li greater_y: A ND Tensor. Must be one of the following types: float16, float32.
* @li select_e: A ND Tensor. Must be one of the following types: float16, float32.
* @li minimum_y: A ND Tensor. Must be one of the following types: float16, float32. \n

*@par Outputs:
*y: A ND Tensor of the same dtype as "input_greater1". \n
...
* @li x1: A ND Tensor. Must be one of the following types: float16, float32.
* @li x2: A ND Tensor. Must be one of the following types: float16, float32.
* @li x3: A ND Tensor. Must be one of the following types: float16, float32.
* @li x4: A ND Tensor. Must be one of the following types: float16, float32.
* @li x5: A ND Tensor. Must be one of the following types: float16, float32.
* @li greater_y: A ND Tensor. Must be one of the following types: float16, float32.
* @li select_e: A ND Tensor. Must be one of the following types: float16, float32. \n

*@par Outputs:
*y: A ND Tensor of the same dtype as input. \n
...
* @li input4: A ND tensor specifying the learning rate. Values must be greater than 0. Support float16, float32, bfloat16.
...
* @li mul4_x: A ND tensor specifying weight. Values must be greater than or equal to 0. Support float16, float32, bfloat16.
* @li add2_y: A ND tensor ued for improving numerical stability. Values must be greater than 0. Support float16, float32, bfloat16. \n
...
*@li input1: A ND Tensor specifying second moment. Values must be greater than or equal to 0. Support float16, float32, bfloat16.
*@li input2: A ND Tensor specifying first moment. Support float16, float32, bfloat16.
*@li input3: A ND Tensor specifying parameters to be updated. Support float16, float32, bfloat16.
...
* @li input2: A ND tensor specifying first moment. Support float16, float32, bfloat16.
* @li input3: A ND tensor specifying parameters to be updated. Support float16, float32, bfloat16.
* @li input4: A ND tensor specifying the learning rate. Values must be greater than 0. Shape size must be equal to 1. Support float16, float32, bfloat16.
* @li mul0_x: A ND tensor specifying beta1. Values must be greater than 0. Shape size must be equal to 1. Support float16, float32, bfloat16.
* @li mul1_x: A ND tensor specifying 1 - beta1. Values must range from 0 to 1. Shape size must be equal to 1. Support float16, float32, bfloat16.
* @li mul2_x: A ND tensor specifying beta2. Values must be greater than 0. Shape size must be equal to 1. Support float16, float32, bfloat16.
* @li mul3_x: A ND tensor specifying 1 - beta2. Values must range from 0 to 1. Shape size must be equal to 1. Support float16, float32, bfloat16.
* @li mul4_x: A ND tensor specifying weight. Values must be greater than or equal to 0. Support float16, float32, bfloat16.
* @li add2_y: A ND tensor ued for improving numerical stability. Values must be greater than 0. Support float16, float32, bfloat16. \n
...
*@par Inputs:
*Ten inputs, including:
* @li input0: A ND Tensor. Must be one of the following types: float16, float32.
* @li input1: A ND Tensor. Must be one of the following types: float16, float32.
* @li input2: A ND Tensor. Must be one of the following types: float16, float32.
* @li input3: A ND Tensor. Must be one of the following types: float16, float32.
* @li input4: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul0_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul1_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul2_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul3_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li add2_y: A ND Tensor. Must be one of the following types: float16, float32. \n
...
* @li grad: A ND Tensor. Must be one of the following types: float16, float32.
* @li inputv: A ND Tensor. Must be one of the following types: float16, float32.
* @li inputm: A ND Tensor. Must be one of the following types: float16, float32.
* @li input3: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul0_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul1_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul2_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li mul3_x: A ND Tensor. Must be one of the following types: float16, float32.
* @li add2_y: A ND Tensor. Must be one of the following types: float16, float32.
* @li steps: A ND Tensor. Must be one of the following types: float16, float32.
* @li do_use_weight: A ND Tensor. Must be one of the following types: float16, float32.
* @li weight_decay_rate: A ND Tensor. Must be one of the following types: float16, float32. \n

*@par Outputs:
*Three outputs, including:
* @li output0: A ND Tensor. Must be one of the following types: float16, float32.
* @li inputv: A ND Tensor. Must be one of the following types: float16, float32.
* @li inputm: A ND Tensor. Must be one of the following types: float16, float32. \n
...
* @li input2: A ND Tensor. Must be one of the following types: float16, float32.
* @li input3: A ND Tensor. Must be one of the following types: float16, float32.
* @li input_param: A ND Tensor. Must be one of the following types: float16, float32. \n

*@par Outputs:
*input_param: A ND Tensor of the same as "input_param". \n
*@par Restrictions:
*Warning: THIS FUNCTION IS EXPERIMENTAL.  Please do not use.
*/
...
*@par Inputs:
*Four inputs, including:
* @li x: A ND Tensor. Must be one of the following types: float16, float32.
* @li greater_zeros: A ND Tensor. Must be one of the following types: float16, float32.
* @li select_ones: A ND Tensor. Must be one of the following types: float16, float32.
* @li maximum_ones: A ND Tensor. Must be one of the following types: float16, float32. \n
...
* @par Inputs:
* x: A ND Tensor of type float16, float32. \n
...
* @par Outputs:
* Two outputs, including: \n
* @li y1: A ND Tensor. Has the same dtype as "x".
* @li y2: A ND Tensor. Has the same dtype as "x".
...
*@par Inputs:
*x1: A ND Tensor of type float32. Support format: FRACTAL_Z,C1HWNCoC0,NC1HWC0,ND. \n
*x2: A ND Tensor of type float32. Support format: FRACTAL_Z,C1HWNCoC0,NC1HWC0,ND. \n

*@par Outputs:
y1: A ND Tensor. Has the same dtype and format as "x1".The result of "x1".
y2: A ND Tensor. Has the same dtype and format as "x2".The result of "x2".
...
REG_OP(Bias)
    ...
    .INPUT(bias, TensorType({DT_FLOAT, DT_FLOAT16, DT_BF16})) /* "Second operand." */
...
*@par Inputs:
*@li input0: A ND Tensor of input of mul, and dtype supports float16, float32.
*@li input1: A ND Tensor of input of mul and mul_1, and dtype supports float16, float32.
*@li input2: A ND Tensor of input of mul_1, and dtype supports float16, float32. \n
...
*@par Outputs:
*@li output0: A ND Tensor result of which input0 dot multiply input1.
*@li output1: A ND Tensor result of which input0 dot multiply input1, then reducesum it.
...
*@par Inputs:
*Three inputs, including:
*@li x1: A ND Tensor of type complex128, complex64, double, float,
* float16, int16, int32, int64, int8, qint32, qint8, quint8, uint16,
* uint32, uint64, uint8, bfloat16, complex32.
*@li x2: A ND Tensor with the same dtype of x1.
*@li x3: A ND Tensor with the same dtype of x1. \n

*@par Outputs:
*@li y1: A ND Tensor of shape and dtype of first output, which should have \n
shape (1,) and dtype as input.
*@li y2: A ND Tensor of shape and dtype of second output, should be same shape and type as input.
...
* @li x1: A ND Tensor. Must be one of the following types: bfloat16, float16, float32,
* double, complex64, complex128.
* @li x2: A ND Tensor. Has the same dtype and shape as "x1". \n
...
/**
* @brief Computes the result of x1 - x2 * alpha. x1/x2 Support broadcasting operations.

* @par Inputs:
* @li x1: An ND tensor of type float16, bfloat16, float32, double, uint8, int8, uint16,
*  int16, int32, int64, complex32, complex64, complex128.
* @li x2: An ND tensor of type float16, bfloat16, float32, double, uint8, int8, uint16,
*  int16, int32, int64, complex32, complex64, complex128.
* @li alpha: A optional tensor of type float16, bfloat16, float32, double, uint8, int8, uint16,
...
* @li var: A ND Tensor of type float16, float32, int32 or int8. \n
* @li indices: A ND Tensor of type int32. \n
* @li updates: A ND Tensor of type float16, float32, int32 or int8. \n
* @li assist: A ND Tensor of int32,also a assist matrix and it's shape must match the shape of var \n
...
*@attention Constraints:
*@li indices: only support int32,and shape same to "updates"
*@li The value range of "dimension" is [-dims, dims - 1]. "dims" is the dimension length of "indices".
*@li y:A ND Tensor, the type and shape is same to "var" \n
...
* @li beta1: A ND Tensor of the exponential decay rate for the 1st moment estimates. Datatype is same as var. Shape (1, ).\n
* @li beta2: A ND Tensor of the exponential decay rate for the 2nd moment estimates. Datatype is same as var. Shape (1, ).\n
...
* @par Attributes:
* @li nan: An required attribute of type float32,
        specifying the value to replace NaNs with.
* @li posinf: An required attribute of type float32,
        specifying the value to replace Infs with.
* @li neginf: An required attribute of type float32,
        specifying the value to replace -Infs with. \n
...
* @li target:A ND Tensor. Must be one of the following types:
        float16, float, int8, int32, uint32, uint8, int64, uint64, int16, uint16, double,
        complex64, complex128, qint8, quint8, qint16, quint16, qint32, bfloat16, bool, string.  \n
