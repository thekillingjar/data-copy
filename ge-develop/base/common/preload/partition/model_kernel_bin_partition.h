...
#ifndef AIR_BASE_COMMON_PRELOAD_MODEL_KERNEL_BIN_PARTITION_H_
#define AIR_BASE_COMMON_PRELOAD_MODEL_KERNEL_BIN_PARTITION_H_
#include "common/preload/partition/model_partition_base.h"

namespace ge {
class ModelKernelBinPartition : public ModelPartitionBase {
 public:
