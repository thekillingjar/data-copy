# SetOriginShape<a name="ZH-CN_TOPIC_0000002488295882"></a>
...
```
e::Status SetOriginShape(const ge::Shape &shape)
```
...
<tbody><tr id="row17472816"><td class="cellrowborder" valign="top" width="10.73%" headers="mcps1.1.4.1.1 "><p id="p1583161612618"><a name="p1583161612618"></a><a name="p1583161612618"></a>shape</p>
</td>
...
<td class="cellrowborder" valign="top" width="77.47%" headers="mcps1.1.4.1.3 "><p id="p14982104013546"><a name="p14982104013546"></a><a name="p14982104013546"></a>原始数据格式。</p>
</td>
</tr>
</tbody>
</table>
