# aclmdlSetAIPPDtcPixelMean<a name="ZH-CN_TOPIC_0000001312481377"></a>
...
<tr id="row1919192774810"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p27151254145011"><a name="p27151254145011"></a><a name="p27151254145011"></a>dtcPixelMeanChn0</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p67055397"><a name="p67055397"></a><a name="p67055397"></a>通道0的均值。</p>
<p id="p1937191115010"><a name="p1937191115010"></a><a name="p1937191115010"></a>取值范围：[0, 255]</p>
</td>
</tr>
<tr id="row273214316518"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p173213436513"><a name="p173213436513"></a><a name="p173213436513"></a>dtcPixelMeanChn1</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p26193631"><a name="p26193631"></a><a name="p26193631"></a>通道1的均值。</p>
<p id="p12778435509"><a name="p12778435509"></a><a name="p12778435509"></a>取值范围：[0, 255]</p>
</td>
</tr>
<tr id="row10945045185116"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p6945104565113"><a name="p6945104565113"></a><a name="p6945104565113"></a>dtcPixelMeanChn2</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p6517326"><a name="p6517326"></a><a name="p6517326"></a>通道2的均值。</p>
<p id="p198923595017"><a name="p198923595017"></a><a name="p198923595017"></a>取值范围：[0, 255]</p>
</td>
</tr>
<tr id="row2197115675116"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p51978563519"><a name="p51978563519"></a><a name="p51978563519"></a>dtcPixelMeanChn3</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p13462075"><a name="p13462075"></a><a name="p13462075"></a>通道3的均值。</p>
<p id="p10466412453"><a name="p10466412453"></a><a name="p10466412453"></a>如果只有3个通道，将该参数设置为0。</p>
<p id="p02421386500"><a name="p02421386500"></a><a name="p02421386500"></a>取值范围：[0, 255]</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p157101358155119"><a name="p157101358155119"></a><a name="p157101358155119"></a>指定对第几个Batch上的图片设置通道均值。</p>
