# aclmdlBundleLoadFromMem<a name="ZH-CN_TOPIC_0000001969384854"></a>
...
<p id="p1413351917712"><a name="p1413351917712"></a><a name="p1413351917712"></a>此处的模型文件是基于构图接口构建出来的，调用aclgrphBundleBuildModel接口编译模型、调用aclgrphBundleSaveModel接口保存模型，再由用户自行将保存出来的om模型文件读入内存。</p>
</td>
</tr>
<tr id="row18987133142614"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p966710213162"><a name="p966710213162"></a><a name="p966710213162"></a>modelSize</p>
</td>
...
<tr id="row1854185610197"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p10541856141916"><a name="p10541856141916"></a><a name="p10541856141916"></a>bundleId</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.2 "><p id="p13541556161915"><a name="p13541556161915"></a><a name="p13541556161915"></a>输出</p>
</td>
