# aclmdlSetAIPPCropParams<a name="ZH-CN_TOPIC_0000001265400234"></a>
...
<tr id="row7909131293411"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p371635485016"><a name="p371635485016"></a><a name="p371635485016"></a>cropSwitch</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p413514194518"><a name="p413514194518"></a><a name="p413514194518"></a>是否对图片执行抠图操作，取值范围：</p>
<a name="ul78228512457"></a><a name="ul78228512457"></a><ul id="ul78228512457"><li>0：不执行抠图操作，设置为0时，则设置cropStartPosW、cropStartPosH、cropSizeW、cropSizeH参数无效</li><li>1：执行抠图操作</li></ul>
<p id="p10321181817457"><a name="p10321181817457"></a><a name="p10321181817457"></a></p>
</td>
</tr>
<tr id="row1919192774810"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p27151254145011"><a name="p27151254145011"></a><a name="p27151254145011"></a>cropStartPosW</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p53371562501"><a name="p53371562501"></a><a name="p53371562501"></a>抠图时，坐标点起始位置在图中横向的坐标。</p>
<p id="p9998195743712"><a name="p9998195743712"></a><a name="p9998195743712"></a>对于YUV420SP_U8格式的图像，参数取值要求是偶数。</p>
<p id="p17781124312471"><a name="p17781124312471"></a><a name="p17781124312471"></a>取值范围：[0,4095]</p>
</td>
</tr>
<tr id="row273214316518"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p173213436513"><a name="p173213436513"></a><a name="p173213436513"></a>cropStartPosH</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p59074896"><a name="p59074896"></a><a name="p59074896"></a>抠图时，坐标点起始位置在图中纵向的坐标。</p>
<p id="p159457753815"><a name="p159457753815"></a><a name="p159457753815"></a>对于YUV420SP_U8格式的图像，参数取值要求是偶数。</p>
<p id="p79321245184710"><a name="p79321245184710"></a><a name="p79321245184710"></a>取值范围：[0,4095]</p>
</td>
</tr>
<tr id="row10945045185116"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p6945104565113"><a name="p6945104565113"></a><a name="p6945104565113"></a>cropSizeW</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p46654138"><a name="p46654138"></a><a name="p46654138"></a>抠图区域的宽度。</p>
<p id="p585232164716"><a name="p585232164716"></a><a name="p585232164716"></a>取值范围：[1,4096]</p>
</td>
</tr>
<tr id="row2197115675116"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p51978563519"><a name="p51978563519"></a><a name="p51978563519"></a>cropSizeH</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p40102457"><a name="p40102457"></a><a name="p40102457"></a>抠图区域的高度。</p>
<p id="p73257354476"><a name="p73257354476"></a><a name="p73257354476"></a>取值范围：[1,4096]</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p157101358155119"><a name="p157101358155119"></a><a name="p157101358155119"></a>指定对第几个Batch上的图片执行抠图操作。</p>
...
## 约束说明<a name="section133035234216"></a>
