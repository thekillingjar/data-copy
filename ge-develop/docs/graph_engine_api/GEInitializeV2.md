# GEInitializeV2<a name="ZH-CN_TOPIC_0000002508557557"></a>
...
<table><thead align="left"><tr id="row47530006"><th class="cellrowborder" valign="top" width="11.63%" id="mcps1.1.4.1.1"><p id="p24725298"><a name="p24725298"></a><a name="p24725298"></a>参数名</p>
</th>
<th class="cellrowborder" valign="top" width="12.73%" id="mcps1.1.4.1.2"><p id="p56592155"><a name="p56592155"></a><a name="p56592155"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="75.64%" id="mcps1.1.4.1.3"><p id="p54897010"><a name="p54897010"></a><a name="p54897010"></a>说明</p>
</th>
</tr>
</thead>
<tbody><tr id="row17472816"><td class="cellrowborder" valign="top" width="11.63%" headers="mcps1.1.4.1.1 "><p id="p8671218103212"><a name="p8671218103212"></a><a name="p8671218103212"></a>options</p>
</td>
<td class="cellrowborder" valign="top" width="12.73%" headers="mcps1.1.4.1.2 "><p id="p17209562"><a name="p17209562"></a><a name="p17209562"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="75.64%" headers="mcps1.1.4.1.3 "><p id="p5876152523216"><a name="p5876152523216"></a><a name="p5876152523216"></a>map表，key为参数类型，value为参数值，均为字符串格式，描述初始化相关的配置信息，当前支持的配置信息请参考<a href="options参数说明.md">options参数说明</a>中<strong id="b11718105431010"><a name="b11718105431010"></a><a name="b11718105431010"></a>全局级别</strong>的参数。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="13.089999999999998%" headers="mcps1.1.4.1.2 "><p id="p2071459847"><a name="p2071459847"></a><a name="p2071459847"></a>Status</p>
</td>
<td class="cellrowborder" valign="top" width="75.13%" headers="mcps1.1.4.1.3 "><p id="p104441542103518"><a name="p104441542103518"></a><a name="p104441542103518"></a>0：初始化成功。</p>
<p id="p644544212355"><a name="p644544212355"></a><a name="p644544212355"></a>其他：初始化失败。</p>
</td>
</tr>
</tbody>
</table>
