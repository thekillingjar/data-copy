# SetDataType<a name="ZH-CN_TOPIC_0000002519215175"></a>
...
<tbody><tr id="row17472816"><td class="cellrowborder" valign="top" width="10.73%" headers="mcps1.1.4.1.1 "><p id="p1583161612618"><a name="p1583161612618"></a><a name="p1583161612618"></a>data_type</p>
</td>
...
<td class="cellrowborder" valign="top" width="77.47%" headers="mcps1.1.4.1.3 "><p id="p185820162619"><a name="p185820162619"></a><a name="p185820162619"></a>数据类型。</p>
</td>
</tr>
</tbody>
</table>
...
## 调用示例<a name="section1287153795419"></a>
