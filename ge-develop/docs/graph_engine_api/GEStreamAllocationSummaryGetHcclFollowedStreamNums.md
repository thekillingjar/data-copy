# GEStreamAllocationSummaryGetHcclFollowedStreamNums<a name="ZH-CN_TOPIC_0000002516987401"></a>
...
<a name="table211710202920"></a>
<table><thead align="left"><tr id="row611720012290"><th class="cellrowborder" valign="top" width="23.54%" id="mcps1.1.4.1.1"><p id="p151171607299"><a name="p151171607299"></a><a name="p151171607299"></a>参数</p>
</th>
<th class="cellrowborder" valign="top" width="7.870000000000001%" id="mcps1.1.4.1.2"><p id="p151175012916"><a name="p151175012916"></a><a name="p151175012916"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="68.58999999999999%" id="mcps1.1.4.1.3"><p id="p411717072914"><a name="p411717072914"></a><a name="p411717072914"></a>说明</p>
</th>
</tr>
</thead>
<tbody><tr id="row21181600293"><td class="cellrowborder" valign="top" width="23.54%" headers="mcps1.1.4.1.1 "><p id="p1311840102916"><a name="p1311840102916"></a><a name="p1311840102916"></a><span>compiled_graph_summary</span></p>
</td>
<td class="cellrowborder" valign="top" width="7.870000000000001%" headers="mcps1.1.4.1.2 "><p id="p61181807290"><a name="p61181807290"></a><a name="p61181807290"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="68.58999999999999%" headers="mcps1.1.4.1.3 "><p id="p111816011299"><a name="p111816011299"></a><a name="p111816011299"></a>图编译后的概要信息。</p>
</td>
</tr>
<tr id="row127391719608"><td class="cellrowborder" valign="top" width="23.54%" headers="mcps1.1.4.1.1 "><p id="p97391819606"><a name="p97391819606"></a><a name="p97391819606"></a><span>graph_to_hccl_followed_stream_nums</span></p>
</td>
<td class="cellrowborder" valign="top" width="7.870000000000001%" headers="mcps1.1.4.1.2 "><p id="p15739719702"><a name="p15739719702"></a><a name="p15739719702"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="68.58999999999999%" headers="mcps1.1.4.1.3 "><p id="p873910195014"><a name="p873910195014"></a><a name="p873910195014"></a>map格式，key为图名称，value为实际通信从流的物理流数量的向量，其中索引表示逻辑流ID。</p>
</td>
</tr>
</tbody>
</table>
