# aclopRegisterCompileFunc<a name="ZH-CN_TOPIC_0000001312481597"></a>
...
<tr id="row7909131293411"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p1912212521619"><a name="p1912212521619"></a><a name="p1912212521619"></a>func</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p212018526117"><a name="p212018526117"></a><a name="p212018526117"></a>算子选择器回调函数，函数定义：</p>
<pre class="screen" id="screen11409204054120"><a name="screen11409204054120"></a><a name="screen11409204054120"></a>typedef aclError (*aclopCompileFunc)(int numInputs, const aclTensorDesc *const inputDesc[], int numOutputs, const aclTensorDesc *const outputDesc[], const aclopAttr *opAttr, aclopKernelDesc *aclopKernelDesc);</pre>
</td>
</tr>
</tbody>
</table>
