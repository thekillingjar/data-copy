# aclSetTensorDescName<a name="ZH-CN_TOPIC_0000001265400486"></a>
...
## 功能说明<a name="section186255582214"></a>

设置TensorDesc的名称。

## 函数原型<a name="section192458119233"></a>

```
void aclSetTensorDescName(aclTensorDesc *desc, const char *name)
```

## 参数说明<a name="section176461416234"></a>
...
<tr id="row10284524113410"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p82851424163417"><a name="p82851424163417"></a><a name="p82851424163417"></a>name</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p1728522417343"><a name="p1728522417343"></a><a name="p1728522417343"></a>TensorDesc名称的指针。</p>
</td>
</tr>
</tbody>
</table>
