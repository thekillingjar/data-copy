# aclSetTensorValueRange<a name="ZH-CN_TOPIC_0000001265081826"></a>
...
<tr id="row1765514213210"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p1565604213211"><a name="p1565604213211"></a><a name="p1565604213211"></a>valueCount</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p06561642103217"><a name="p06561642103217"></a><a name="p06561642103217"></a>需设置范围的数据值的个数。</p>
</td>
</tr>
<tr id="row20516369497"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p15525362493"><a name="p15525362493"></a><a name="p15525362493"></a>valueRange</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p15521014104216"><a name="p15521014104216"></a><a name="p15521014104216"></a>valueRange为每个数据值的范围，用二维数组表示范围。</p>
<pre class="screen" id="screen739781643510"><a name="screen739781643510"></a><a name="screen739781643510"></a>#define ACL_TENSOR_VALUE_RANGE_NUM 2</pre>
</td>
</tr>
</tbody>
</table>
