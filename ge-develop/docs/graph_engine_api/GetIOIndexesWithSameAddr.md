# GetIOIndexesWithSameAddr<a name="ZH-CN_TOPIC_0000002516573397"></a>
...
<tbody><tr id="zh-cn_topic_0204328224_zh-cn_topic_0182636394_row20315681"><td class="cellrowborder" valign="top" width="11.16%" headers="mcps1.1.4.1.1 "><p id="p1963855292513"><a name="p1963855292513"></a><a name="p1963855292513"></a>io_indexes</p>
</td>
...
<td class="cellrowborder" valign="top" width="79.60000000000001%" headers="mcps1.1.4.1.3 "><p id="p1263885218251"><a name="p1263885218251"></a><a name="p1263885218251"></a>输入/输出索引对。</p>
</td>
</tr>
</tbody>
</table>
...
<table><thead align="left"><tr id="row28073419"><th class="cellrowborder" valign="top" width="11.44%" id="mcps1.1.4.1.1"><p id="p59354473"><a name="p59354473"></a><a name="p59354473"></a>参数名</p>
</th>
<th class="cellrowborder" valign="top" width="9.33%" id="mcps1.1.4.1.2"><p id="p42983048"><a name="p42983048"></a><a name="p42983048"></a>类型</p>
</th>
<th class="cellrowborder" valign="top" width="79.23%" id="mcps1.1.4.1.3"><p id="p59074896"><a name="p59074896"></a><a name="p59074896"></a>说明</p>
</th>
</tr>
</thead>
<tbody><tr id="row20337256"><td class="cellrowborder" valign="top" width="11.44%" headers="mcps1.1.4.1.1 "><p id="p36705016"><a name="p36705016"></a><a name="p36705016"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="9.33%" headers="mcps1.1.4.1.2 "><p id="p20316329"><a name="p20316329"></a><a name="p20316329"></a>Status</p>
</td>
<td class="cellrowborder" valign="top" width="79.23%" headers="mcps1.1.4.1.3 "><a name="ul1343942615010"></a><a name="ul1343942615010"></a><ul id="ul1343942615010"><li>SUCCESS：接口调用成功。</li><li>FAILED：接口调用失败。</li></ul>
</td>
</tr>
</tbody>
</table>
