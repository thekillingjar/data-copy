# aclmdlBundleGetModelId<a name="ZH-CN_TOPIC_0000002006025229"></a>
...
<tr id="row18987133142614"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p966710213162"><a name="p966710213162"></a><a name="p966710213162"></a>index</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.2 "><p id="p66671229166"><a name="p66671229166"></a><a name="p66671229166"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p866642171612"><a name="p866642171612"></a><a name="p866642171612"></a>索引。</p>
<p id="p5103103751315"><a name="p5103103751315"></a><a name="p5103103751315"></a>用户调用<a href="aclmdlBundleGetModelNum.md">aclmdlBundleGetModelNum</a>接口获取模型数量后，这个index的取值范围：[0, (模型数量-1)]。</p>
</td>
</tr>
<tr id="row20121163582016"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p112111357203"><a name="p112111357203"></a><a name="p112111357203"></a>modelId</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.2 "><p id="p10121835182015"><a name="p10121835182015"></a><a name="p10121835182015"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p13121173518208"><a name="p13121173518208"></a><a name="p13121173518208"></a>实际可执行的模型ID。</p>
</td>
</tr>
</tbody>
</table>
