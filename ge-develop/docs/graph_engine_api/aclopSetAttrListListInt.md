# aclopSetAttrListListInt<a name="ZH-CN_TOPIC_0000001312481857"></a>
...
## 功能说明<a name="section1653614942319"></a>

设置int64\_t类型列表的属性值。

## 函数原型<a name="section738435210232"></a>
...
## 参数说明<a name="section165340559236"></a>
...
<tr id="row16554310184012"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p955511054020"><a name="p955511054020"></a><a name="p955511054020"></a>numLists</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.2 "><p id="p13555210104012"><a name="p13555210104012"></a><a name="p13555210104012"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p1055531084019"><a name="p1055531084019"></a><a name="p1055531084019"></a>列表数目。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p1133284102913"><a name="p1133284102913"></a><a name="p1133284102913"></a>列表中属性值数目。</p>
<p id="p176141119123511"><a name="p176141119123511"></a><a name="p176141119123511"></a>numValues是一个数组，数组中的每个元素表示每个列表中的属性值数目。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p15915471291"><a name="p15915471291"></a><a name="p15915471291"></a>列表中属性值的指针数组。</p>
</td>
</tr>
</tbody>
</table>

## 返回值说明<a name="section73241458202315"></a>
