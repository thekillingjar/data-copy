# IsGraphNeedRebuild<a name="ZH-CN_TOPIC_0000001312404893"></a>
...
<th class="cellrowborder" valign="top" width="14.08%" id="mcps1.1.4.1.2"><p id="p56592155"><a name="p56592155"></a><a name="p56592155"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="72.28999999999999%" id="mcps1.1.4.1.3"><p id="p54897010"><a name="p54897010"></a><a name="p54897010"></a>说明</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="14.08%" headers="mcps1.1.4.1.2 "><p id="p17209562"><a name="p17209562"></a><a name="p17209562"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="72.28999999999999%" headers="mcps1.1.4.1.3 "><p id="p270712592519"><a name="p270712592519"></a><a name="p270712592519"></a>子图对应的ID。</p>
</td>
</tr>
</tbody>
</table>
...
<table><thead align="left"><tr id="row1832323"><th class="cellrowborder" valign="top" width="14.46%" id="mcps1.1.4.1.1"><p id="p14200498"><a name="p14200498"></a><a name="p14200498"></a>参数名</p>
</th>
<th class="cellrowborder" valign="top" width="13.38%" id="mcps1.1.4.1.2"><p id="p9389685"><a name="p9389685"></a><a name="p9389685"></a>类型</p>
</th>
<th class="cellrowborder" valign="top" width="72.16%" id="mcps1.1.4.1.3"><p id="p22367029"><a name="p22367029"></a><a name="p22367029"></a>说明</p>
</th>
</tr>
</thead>
<tbody><tr id="row66898905"><td class="cellrowborder" valign="top" width="14.46%" headers="mcps1.1.4.1.1 "><p id="p50102218"><a name="p50102218"></a><a name="p50102218"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="13.38%" headers="mcps1.1.4.1.2 "><p id="p31747823"><a name="p31747823"></a><a name="p31747823"></a>bool</p>
</td>
<td class="cellrowborder" valign="top" width="72.16%" headers="mcps1.1.4.1.3 "><a name="ul13509837151916"></a><a name="ul13509837151916"></a><ul id="ul13509837151916"><li>False：图可以正常调用<a href="RunGraphAsync.md">RunGraphAsync</a>。</li><li>True：需要<a href="RemoveGraph.md">RemoveGraph</a>后，重新<a href="AddGraph.md">AddGraph</a>和<a href="BuildGraph.md">BuildGraph</a>。</li></ul>
</td>
</tr>
</tbody>
</table>
