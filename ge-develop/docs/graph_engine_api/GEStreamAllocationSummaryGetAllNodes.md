# GEStreamAllocationSummaryGetAllNodes<a name="ZH-CN_TOPIC_0000002484667494"></a>
...
<a name="table67731745297"></a>
<table><thead align="left"><tr id="row177312462914"><th class="cellrowborder" valign="top" width="18.92%" id="mcps1.1.4.1.1"><p id="p177319419293"><a name="p177319419293"></a><a name="p177319419293"></a>参数</p>
</th>
<th class="cellrowborder" valign="top" width="9.64%" id="mcps1.1.4.1.2"><p id="p1277313414290"><a name="p1277313414290"></a><a name="p1277313414290"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="71.44%" id="mcps1.1.4.1.3"><p id="p157736416298"><a name="p157736416298"></a><a name="p157736416298"></a>说明</p>
</th>
</tr>
</thead>
<tbody><tr id="row16773134182920"><td class="cellrowborder" valign="top" width="18.92%" headers="mcps1.1.4.1.1 "><p id="p19773184192910"><a name="p19773184192910"></a><a name="p19773184192910"></a><span>compiled_graph_summary</span></p>
</td>
<td class="cellrowborder" valign="top" width="9.64%" headers="mcps1.1.4.1.2 "><p id="p477310422918"><a name="p477310422918"></a><a name="p477310422918"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="71.44%" headers="mcps1.1.4.1.3 "><p id="p57738462918"><a name="p57738462918"></a><a name="p57738462918"></a>图编译后的概要信息。</p>
</td>
</tr>
<tr id="row127391719608"><td class="cellrowborder" valign="top" width="18.92%" headers="mcps1.1.4.1.1 "><p id="p97391819606"><a name="p97391819606"></a><a name="p97391819606"></a>graph_to_all_nodes</p>
</td>
...
<td class="cellrowborder" valign="top" width="71.44%" headers="mcps1.1.4.1.3 "><p id="p873910195014"><a name="p873910195014"></a><a name="p873910195014"></a>map格式，key为图名称，value为所有节点的向量，其中索引表示逻辑流ID。</p>
</td>
</tr>
</tbody>
</table>
