# SetGraphConstMemoryBase<a name="ZH-CN_TOPIC_0000002508677543"></a>
...
在调用本接口前，必须先调用[CompileGraph](CompileGraph-2.md)接口进行图编译；内存大小从[GetCompiledGraphSummary](GetCompiledGraphSummary-3.md)\>**GetConstMemorySize**接口中获取。
