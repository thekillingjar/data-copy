# GeSession构造函数和析构函数<a name="ZH-CN_TOPIC_0000002508677529"></a>
...
<td class="cellrowborder" valign="top" width="80.03%" headers="mcps1.1.4.1.3 "><p id="p18652125115618"><a name="p18652125115618"></a><a name="p18652125115618"></a>map表，key为参数类型，value为参数值，均为字符串格式，描述GeSession的配置信息。</p>
<p id="zh-cn_topic_0204328224_zh-cn_topic_0182636394_p15921183410"><a name="zh-cn_topic_0204328224_zh-cn_topic_0182636394_p15921183410"></a><a name="zh-cn_topic_0204328224_zh-cn_topic_0182636394_p15921183410"></a>一般情况下可不填，与GEInitializeV2传入的全局options保持一致。</p>
<p id="p155019231136"><a name="p155019231136"></a><a name="p155019231136"></a>如需单独配置当前GeSession的配置信息时，可以通过此参数配置，支持的配置项请参见<a href="options参数说明.md">options参数说明</a>中<strong id="b11718105431010"><a name="b11718105431010"></a><a name="b11718105431010"></a>session级别</strong>的参数。</p>
</td>
</tr>
</tbody>
</table>
