# UnregisterExternalAllocator<a name="ZH-CN_TOPIC_0000001628421713"></a>
...
<table><thead align="left"><tr id="row47530006"><th class="cellrowborder" valign="top" width="14.540000000000001%" id="mcps1.1.4.1.1"><p id="p24725298"><a name="p24725298"></a><a name="p24725298"></a>参数名</p>
</th>
<th class="cellrowborder" valign="top" width="13.36%" id="mcps1.1.4.1.2"><p id="p56592155"><a name="p56592155"></a><a name="p56592155"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="72.1%" id="mcps1.1.4.1.3"><p id="p54897010"><a name="p54897010"></a><a name="p54897010"></a>说明</p>
</th>
</tr>
</thead>
<tbody><tr id="row17472816"><td class="cellrowborder" valign="top" width="14.540000000000001%" headers="mcps1.1.4.1.1 "><p id="p6475110121816"><a name="p6475110121816"></a><a name="p6475110121816"></a>stream</p>
</td>
<td class="cellrowborder" valign="top" width="13.36%" headers="mcps1.1.4.1.2 "><p id="p5473150131815"><a name="p5473150131815"></a><a name="p5473150131815"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="72.1%" headers="mcps1.1.4.1.3 "><p id="p547017041819"><a name="p547017041819"></a><a name="p547017041819"></a>指定需要销毁的用户Allocator在哪个流上。</p>
</td>
</tr>
</tbody>
</table>
...
<table><thead align="left"><tr id="row1832323"><th class="cellrowborder" valign="top" width="14.469999999999999%" id="mcps1.1.4.1.1"><p id="p14200498"><a name="p14200498"></a><a name="p14200498"></a>参数名</p>
</th>
...
<th class="cellrowborder" valign="top" width="70.95%" id="mcps1.1.4.1.3"><p id="p22367029"><a name="p22367029"></a><a name="p22367029"></a>说明</p>
</th>
</tr>
</thead>
<tbody><tr id="row66898905"><td class="cellrowborder" valign="top" width="14.469999999999999%" headers="mcps1.1.4.1.1 "><p id="p50102218"><a name="p50102218"></a><a name="p50102218"></a>-</p>
</td>
...
<td class="cellrowborder" valign="top" width="70.95%" headers="mcps1.1.4.1.3 "><p id="p141243178210"><a name="p141243178210"></a><a name="p141243178210"></a>SUCCESS：设置成功。</p>
