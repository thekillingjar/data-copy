# EsBuildGraphAndReset<a name="ZH-CN_TOPIC_0000002520345001"></a>
...
<tbody><tr id="row17472816"><td class="cellrowborder" valign="top" width="10.73%" headers="mcps1.1.4.1.1 "><p id="p1723715313220"><a name="p1723715313220"></a><a name="p1723715313220"></a>graph</p>
</td>
...
<th class="cellrowborder" valign="top" width="13.15%" id="mcps1.1.4.1.2"><p id="p9389685"><a name="p9389685"></a><a name="p9389685"></a>类型</p>
</th>
<th class="cellrowborder" valign="top" width="75.79%" id="mcps1.1.4.1.3"><p id="p22367029"><a name="p22367029"></a><a name="p22367029"></a>说明</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="13.15%" headers="mcps1.1.4.1.2 "><p id="p14769451333"><a name="p14769451333"></a><a name="p14769451333"></a>EsCGraph</p>
</td>
<td class="cellrowborder" valign="top" width="75.79%" headers="mcps1.1.4.1.3 "><p id="p11229151215313"><a name="p11229151215313"></a><a name="p11229151215313"></a>成功返回图指针，失败返回nullptr。所有权转移给调用方，调用后图构建器将不再可用。</p>
</td>
</tr>
</tbody>
</table>
