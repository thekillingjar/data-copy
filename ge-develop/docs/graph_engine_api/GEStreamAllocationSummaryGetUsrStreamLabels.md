# GEStreamAllocationSummaryGetUsrStreamLabels<a name="ZH-CN_TOPIC_0000002516987399"></a>
...
<table><thead align="left"><tr id="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_row6223476444"><th class="cellrowborder" valign="top" width="22.45%" id="mcps1.1.4.1.1"><p id="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p10223674448"><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p10223674448"></a><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p10223674448"></a>参数</p>
</th>
<th class="cellrowborder" valign="top" width="10.549999999999999%" id="mcps1.1.4.1.2"><p id="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p645511218169"><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p645511218169"></a><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p645511218169"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="67%" id="mcps1.1.4.1.3"><p id="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p1922337124411"><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p1922337124411"></a><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p1922337124411"></a>说明</p>
</th>
</tr>
</thead>
<tbody><tr id="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_row152234713443"><td class="cellrowborder" valign="top" width="22.45%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p8563195616313"><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p8563195616313"></a><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p8563195616313"></a><span>compiled_graph_summary</span></p>
</td>
<td class="cellrowborder" valign="top" width="10.549999999999999%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p15663137127"><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p15663137127"></a><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p15663137127"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="67%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p2684123934216"><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p2684123934216"></a><a name="zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_p2684123934216"></a>图编译后的概要信息。</p>
</td>
</tr>
<tr id="row127391719608"><td class="cellrowborder" valign="top" width="22.45%" headers="mcps1.1.4.1.1 "><p id="p97391819606"><a name="p97391819606"></a><a name="p97391819606"></a><span>graph_to_user_stream_labels</span></p>
</td>
<td class="cellrowborder" valign="top" width="10.549999999999999%" headers="mcps1.1.4.1.2 "><p id="p15739719702"><a name="p15739719702"></a><a name="p15739719702"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="67%" headers="mcps1.1.4.1.3 "><p id="p873910195014"><a name="p873910195014"></a><a name="p873910195014"></a>map格式，key为图名称，value为用户流标签的向量，其中索引为逻辑流ID。</p>
</td>
</tr>
</tbody>
</table>
...
<table><thead align="left"><tr id="row28073419"><th class="cellrowborder" valign="top" width="23.72%" id="mcps1.1.4.1.1"><p id="p59354473"><a name="p59354473"></a><a name="p59354473"></a>参数名</p>
</th>
<th class="cellrowborder" valign="top" width="10.040000000000001%" id="mcps1.1.4.1.2"><p id="p42983048"><a name="p42983048"></a><a name="p42983048"></a>类型</p>
</th>
<th class="cellrowborder" valign="top" width="66.24%" id="mcps1.1.4.1.3"><p id="p59074896"><a name="p59074896"></a><a name="p59074896"></a>说明</p>
</th>
</tr>
</thead>
<tbody><tr id="row20337256"><td class="cellrowborder" valign="top" width="23.72%" headers="mcps1.1.4.1.1 "><p id="p36705016"><a name="p36705016"></a><a name="p36705016"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="10.040000000000001%" headers="mcps1.1.4.1.2 "><p id="p20316329"><a name="p20316329"></a><a name="p20316329"></a><span>ge::Status</span></p>
</td>
<td class="cellrowborder" valign="top" width="66.24%" headers="mcps1.1.4.1.3 "><a name="ul1343942615010"></a><a name="ul1343942615010"></a><ul id="ul1343942615010"><li>SUCCESS：接口调用成功。</li><li>FAILED：接口调用失败</li></ul>
</td>
</tr>
</tbody>
</table>
