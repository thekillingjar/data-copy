# RegisterCallBackFunc<a name="ZH-CN_TOPIC_0000001265404758"></a>
...
<a name="screen24666397469"></a><a name="screen24666397469"></a><pre class="screen" codetype="Cpp" id="screen24666397469">typedef uint32_t(*pCallBackFunc)(uint32_t graph_id, const std::map&lt;std::string, ge::Tensor&gt; &amp;params_list);
typedef uint32_t session::(*pCallBackFunc)(uint32_t graph_id, const std::map&lt;AscendString, ge::Tensor&gt; &amp;params_list);</pre>
</td>
</tr>
</tbody>
</table>
