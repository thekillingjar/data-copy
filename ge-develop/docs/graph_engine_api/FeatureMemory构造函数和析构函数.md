# FeatureMemory构造函数和析构函数<a name="ZH-CN_TOPIC_0000002516844111"></a>
...
## 头文件/库文件<a name="section83031525204214"></a>

-   头文件：\#include <ge/ge\_feature\_memory.h\>
-   库文件：libge\_compiler.so

## 功能说明<a name="zh-cn_topic_0204328165_zh-cn_topic_0182636384_section36893359"></a>

FeatureMemory构造函数和析构函数。
