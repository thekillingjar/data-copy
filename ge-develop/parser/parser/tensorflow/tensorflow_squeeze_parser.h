...
#ifndef PARSER_TENSORFLOW_TENSORFLOW_SQUEEZE_PARSER_H_
#define PARSER_TENSORFLOW_TENSORFLOW_SQUEEZE_PARSER_H_
...
#endif  // PARSER_TENSORFLOW_TENSORFLOW_SQUEEZE_PARSER_H_
