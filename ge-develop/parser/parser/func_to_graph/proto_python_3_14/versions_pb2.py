...
_VERSIONDEF = _descriptor.Descriptor(
  name='VersionDef',
  full_name='domi.tensorflow.VersionDef',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='producer', full_name='domi.tensorflow.VersionDef.producer', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='min_consumer', full_name='domi.tensorflow.VersionDef.min_consumer', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bad_consumers', full_name='domi.tensorflow.VersionDef.bad_consumers', index=2,
...
VersionDef = _reflection.GeneratedProtocolMessageType('VersionDef', (_message.Message,), {
  ...
  '__module__' : 'versions_pb2'
  # @@protoc_insertion_point(class_scope:domi.tensorflow.VersionDef)
  })
