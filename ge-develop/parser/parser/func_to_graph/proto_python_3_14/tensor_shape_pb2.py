...
_TENSORSHAPEPROTO_DIM = _descriptor.Descriptor(
  name='Dim',
  full_name='domi.tensorflow.TensorShapeProto.Dim',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='domi.tensorflow.TensorShapeProto.Dim.size', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='domi.tensorflow.TensorShapeProto.Dim.name', index=1,
...
_TENSORSHAPEPROTO = _descriptor.Descriptor(
  ...
  full_name='domi.tensorflow.TensorShapeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='dim', full_name='domi.tensorflow.TensorShapeProto.dim', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='unknown_rank', full_name='domi.tensorflow.TensorShapeProto.unknown_rank', index=1,
...
TensorShapeProto = _reflection.GeneratedProtocolMessageType('TensorShapeProto', (_message.Message,), {
  ...
  'Dim' : _reflection.GeneratedProtocolMessageType('Dim', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:domi.tensorflow.TensorShapeProto.Dim)
    })
  ,
  'DESCRIPTOR' : _TENSORSHAPEPROTO,
  '__module__' : 'tensor_shape_pb2'
  # @@protoc_insertion_point(class_scope:domi.tensorflow.TensorShapeProto)
  })
