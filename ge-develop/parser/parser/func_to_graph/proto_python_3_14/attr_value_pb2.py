...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x10\x61ttr_value.proto\x12\x0f\x64omi.tensorflow\x1a\x0ctensor.proto\x1a\x12tensor_shape.proto\x1a\x0btypes.proto\"\xd3\x04\n\tAttrValue\x12\x0b\n\x01s\x18\x02 \x01(\x0cH\x00\x12\x0b\n\x01i\x18\x03 \x01(\x03H\x00\x12\x0b\n\x01\x66\x18\x04 \x01(\x02H\x00\x12\x0b\n\x01\x62\x18\x05 \x01(\x08H\x00\x12)\n\x04type\x18\x06 \x01(\x0e\x32\x19.domi.tensorflow.DataTypeH\x00\x12\x32\n\x05shape\x18\x07 \x01(\x0b\x32!.domi.tensorflow.TensorShapeProtoH\x00\x12.\n\x06tensor\x18\x08 \x01(\x0b\x32\x1c.domi.tensorflow.TensorProtoH\x00\x12\x34\n\x04list\x18\x01 \x01(\x0b\x32$.domi.tensorflow.AttrValue.ListValueH\x00\x12-\n\x04\x66unc\x18\n \x01(\x0b\x32\x1d.domi.tensorflow.NameAttrListH\x00\x12\x15\n\x0bplaceholder\x18\t \x01(\tH\x00\x1a\xfd\x01\n\tListValue\x12\t\n\x01s\x18\x02 \x03(\x0c\x12\r\n\x01i\x18\x03 \x03(\x03\x42\x02\x10\x01\x12\r\n\x01\x66\x18\x04 \x03(\x02\x42\x02\x10\x01\x12\r\n\x01\x62\x18\x05 \x03(\x08\x42\x02\x10\x01\x12+\n\x04type\x18\x06 \x03(\x0e\x32\x19.domi.tensorflow.DataTypeB\x02\x10\x01\x12\x30\n\x05shape\x18\x07 \x03(\x0b\x32!.domi.tensorflow.TensorShapeProto\x12,\n\x06tensor\x18\x08 \x03(\x0b\x32\x1c.domi.tensorflow.TensorProto\x12+\n\x04\x66unc\x18\t \x03(\x0b\x32\x1d.domi.tensorflow.NameAttrListB\x07\n\x05value\"\x9c\x01\n\x0cNameAttrList\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x35\n\x04\x61ttr\x18\x02 \x03(\x0b\x32\'.domi.tensorflow.NameAttrList.AttrEntry\x1aG\n\tAttrEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12)\n\x05value\x18\x02 \x01(\x0b\x32\x1a.domi.tensorflow.AttrValue:\x02\x38\x01\x42\x30\n\x18org.tensorflow.frameworkB\x0f\x41ttrValueProtosP\x01\xf8\x01\x01\x62\x06proto3'
  ,
  dependencies=[tensor__pb2.DESCRIPTOR,tensor__shape__pb2.DESCRIPTOR,types__pb2.DESCRIPTOR,])
...
_ATTRVALUE_LISTVALUE = _descriptor.Descriptor(
  name='ListValue',
  full_name='domi.tensorflow.AttrValue.ListValue',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='s', full_name='domi.tensorflow.AttrValue.ListValue.s', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='i', full_name='domi.tensorflow.AttrValue.ListValue.i', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='f', full_name='domi.tensorflow.AttrValue.ListValue.f', index=2,
      ...
      serialized_options=b'\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='b', full_name='domi.tensorflow.AttrValue.ListValue.b', index=3,
      ...
      serialized_options=b'\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='domi.tensorflow.AttrValue.ListValue.type', index=4,
      ...
      serialized_options=b'\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='shape', full_name='domi.tensorflow.AttrValue.ListValue.shape', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tensor', full_name='domi.tensorflow.AttrValue.ListValue.tensor', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='func', full_name='domi.tensorflow.AttrValue.ListValue.func', index=7,
...
_ATTRVALUE = _descriptor.Descriptor(
  name='AttrValue',
  full_name='domi.tensorflow.AttrValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='s', full_name='domi.tensorflow.AttrValue.s', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='i', full_name='domi.tensorflow.AttrValue.i', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='f', full_name='domi.tensorflow.AttrValue.f', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='b', full_name='domi.tensorflow.AttrValue.b', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='domi.tensorflow.AttrValue.type', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='shape', full_name='domi.tensorflow.AttrValue.shape', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tensor', full_name='domi.tensorflow.AttrValue.tensor', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='list', full_name='domi.tensorflow.AttrValue.list', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='func', full_name='domi.tensorflow.AttrValue.func', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='placeholder', full_name='domi.tensorflow.AttrValue.placeholder', index=9,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='domi.tensorflow.AttrValue.value',
...
_NAMEATTRLIST_ATTRENTRY = _descriptor.Descriptor(
  name='AttrEntry',
  full_name='domi.tensorflow.NameAttrList.AttrEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='domi.tensorflow.NameAttrList.AttrEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='domi.tensorflow.NameAttrList.AttrEntry.value', index=1,
...
_NAMEATTRLIST = _descriptor.Descriptor(
  name='NameAttrList',
  full_name='domi.tensorflow.NameAttrList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='domi.tensorflow.NameAttrList.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='attr', full_name='domi.tensorflow.NameAttrList.attr', index=1,
...
_ATTRVALUE_LISTVALUE.fields_by_name['type'].enum_type = types__pb2._DATATYPE
_ATTRVALUE_LISTVALUE.fields_by_name['shape'].message_type = tensor__shape__pb2._TENSORSHAPEPROTO
_ATTRVALUE_LISTVALUE.fields_by_name['tensor'].message_type = tensor__pb2._TENSORPROTO
_ATTRVALUE_LISTVALUE.fields_by_name['func'].message_type = _NAMEATTRLIST
_ATTRVALUE_LISTVALUE.containing_type = _ATTRVALUE
_ATTRVALUE.fields_by_name['type'].enum_type = types__pb2._DATATYPE
_ATTRVALUE.fields_by_name['shape'].message_type = tensor__shape__pb2._TENSORSHAPEPROTO
_ATTRVALUE.fields_by_name['tensor'].message_type = tensor__pb2._TENSORPROTO
...
AttrValue = _reflection.GeneratedProtocolMessageType('AttrValue', (_message.Message,), {
  ...
  'ListValue' : _reflection.GeneratedProtocolMessageType('ListValue', (_message.Message,), {
    ...
    '__module__' : 'attr_value_pb2'
    # @@protoc_insertion_point(class_scope:domi.tensorflow.AttrValue.ListValue)
    })
  ,
  'DESCRIPTOR' : _ATTRVALUE,
  '__module__' : 'attr_value_pb2'
  # @@protoc_insertion_point(class_scope:domi.tensorflow.AttrValue)
  })
...
NameAttrList = _reflection.GeneratedProtocolMessageType('NameAttrList', (_message.Message,), {
  ...
  'AttrEntry' : _reflection.GeneratedProtocolMessageType('AttrEntry', (_message.Message,), {
    ...
    '__module__' : 'attr_value_pb2'
    # @@protoc_insertion_point(class_scope:domi.tensorflow.NameAttrList.AttrEntry)
    })
  ,
  'DESCRIPTOR' : _NAMEATTRLIST,
  '__module__' : 'attr_value_pb2'
  # @@protoc_insertion_point(class_scope:domi.tensorflow.NameAttrList)
  })
