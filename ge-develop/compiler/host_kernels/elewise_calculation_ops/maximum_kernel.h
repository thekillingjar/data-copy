...
#ifndef GE_GRAPH_PASSES_FOLDING_KERNEL_MAXIMUM_KERNEL_H_
...
class MaximumKernel : public Kernel {
 ...
 private:
  Status MaximumCheck(const std::vector<ConstGeTensorPtr> &input) const;
};
}  // namespace ge

#endif  // GE_GRAPH_PASSES_FOLDING_KERNEL_MAXIMUM_KERNEL_H_
