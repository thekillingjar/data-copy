...
#ifndef GE_GRAPH_PASSES_FOLDING_KERNEL_FLATTENV2_KERNEL_H_
#define GE_GRAPH_PASSES_FOLDING_KERNEL_FLATTENV2_KERNEL_H_
...
namespace ge {
class FlattenV2Kernel : public Kernel {
 public:
...
#endif  // GE_GRAPH_PASSES_FOLDING_KERNEL_FLATTENV2_KERNEL_H_
