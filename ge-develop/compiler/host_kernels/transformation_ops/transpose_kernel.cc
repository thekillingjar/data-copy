...
Status TransposeKernel::ValidateInput(const OpDescPtr &op_desc_ptr, const std::vector<ConstGeTensorPtr> &input) const {
...
REGISTER_COMPUTE_NODE_KERNEL(TRANSPOSE, TransposeKernel);
}  // namespace ge
