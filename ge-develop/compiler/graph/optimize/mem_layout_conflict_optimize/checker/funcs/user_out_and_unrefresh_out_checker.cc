...
Status UserOutputAndNotSupportedAddressRefreshOutputChecker(CheckFuncContext &context) {
...
REGISTER_FUNC(ANCHOR_ATTR_USER_MEMORY_OUTPUT, ANCHOR_ATTR_UNSUPPORTED_ADDRESS_REFRESH_OPERATOR_OUTPUT,
              UserOutputAndNotSupportedAddressRefreshOutputChecker);
}  // namespace ge
