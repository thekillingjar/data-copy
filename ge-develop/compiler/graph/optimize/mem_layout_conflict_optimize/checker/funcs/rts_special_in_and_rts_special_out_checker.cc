...
namespace ge {
Status RtsSpecialInputAndRtsSpecialOutputChecker(CheckFuncContext &context) {
  ...
  const auto &node_index_io =
    context.node_a.io_type_ == IOType::kOut ?
...
REGISTER_FUNC(ANCHOR_ATTR_RTS_SPECIAL_TYPE_INPUT, ANCHOR_ATTR_RTS_SPECIAL_TYPE_OUTPUT,
              RtsSpecialInputAndRtsSpecialOutputChecker);
}  // namespace ge
