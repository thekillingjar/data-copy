...
class PrecisionImprover {
 public:
  static Status ImprovePrecisionToFp32(const ComputeGraphPtr &ge_or_fused_asc_backend_graph);
};
}  // namespace ge
#endif  // AUTOFUSE_POST_PROCESS_SCHEDULER_ADAPTER_ADAPTION_IMPROVE_PRECISION_H
