...
#ifndef AIR_COMPILER_ENGINES_NNENG_OPTIMIZER_GRAPH_OPTIMIZER_OP_JUDGE_FORMAT_AND_DTYPE_STRATEGY_DTYPE_STRATEGY_OP_DTYPE_SELECTION_STRATEGY_FORCE_FP16_H_
#define AIR_COMPILER_ENGINES_NNENG_OPTIMIZER_GRAPH_OPTIMIZER_OP_JUDGE_FORMAT_AND_DTYPE_STRATEGY_DTYPE_STRATEGY_OP_DTYPE_SELECTION_STRATEGY_FORCE_FP16_H_
...
class OpDtypeSelectionStrategyForceFp16 : public OpDtypeSeletionStrategyBase {
 public:
  explicit OpDtypeSelectionStrategyForceFp16(FormatDtypeQuerierPtr format_dtype_querier_ptr,
                                             OpDtypeRiseMatcherPtr op_dtype_rise_matcher_ptr);

  ~OpDtypeSelectionStrategyForceFp16() override;
