...
const std::string kPassNameAttr = "pass_name";

const std::string kPassNameUbAttr = "pass_name_ub";

const std::string kAttrNameIsFusionOp = "_is_fusion_op";
...
const std::string kAscendcSuperKernelScope = "_ascendc_superkernel_scope";

const std::string kAscendcSuperKernelSubId = "_ascendc_sp_sub_id";

const std::string kSuperKernelPrefix = "superkernel";
...
const std::string CUSTOM_OP_FILE_PATH = "custom_op_file_path";

const std::string OPS_PATH_NAME_PREFIX = "ops_path_name_prefix";

const std::string ATTR_KEY_ATOMIC_KERNEL_NAME = "_atomic_kernelname";

const std::string ATTR_NAME_UB_FUSION_SPACE_SIZE = "_ub_fusion_space_size";
...
extern const std::string kOpDfxOptions;
