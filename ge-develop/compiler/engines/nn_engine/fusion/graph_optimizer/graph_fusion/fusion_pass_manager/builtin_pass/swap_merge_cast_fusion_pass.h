...
#ifndef FUSION_ENGINE_FUSION_GRAPH_OPTIMIZER_GRAPH_FUSION_FUSION_PASS_MANAGER_BUILTIN_PASS_SWAP_MERGE_CAST_FUSION_PASS_H_
#define FUSION_ENGINE_FUSION_GRAPH_OPTIMIZER_GRAPH_FUSION_FUSION_PASS_MANAGER_BUILTIN_PASS_SWAP_MERGE_CAST_FUSION_PASS_H_
...
class SwapMergeCastFusionPass : public PatternFusionBasePass {
 ...
 private:
  ...
  Status RelinkMergeNode(const ge::NodePtr &merge_node, const ge::NodePtr &cast_node,
...
#endif  // FUSION_ENGINE_FUSION_GRAPH_OPTIMIZER_GRAPH_FUSION_FUSION_PASS_MANAGER_BUILTIN_PASS_SWAP_MERGE_CAST_FUSION_PASS_H_
