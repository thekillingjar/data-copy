...
#ifndef AIR_COMPILER_GRAPHCOMPILER_ENGINES_NNENG_FUSION_UB_PASS_SLICE_INFO_CONV_ELTWISE_SLICE_INFO_H_
#define AIR_COMPILER_GRAPHCOMPILER_ENGINES_NNENG_FUSION_UB_PASS_SLICE_INFO_CONV_ELTWISE_SLICE_INFO_H_

#include <vector>
#include "ub_pass_slice_info/ub_pass_slice_info_base.h"

namespace fe {
class ConvEltwiseSliceInfo : public UbPassSliceInfoBase {
 protected:
...
#endif  // AIR_COMPILER_GRAPHCOMPILER_ENGINES_NNENG_FUSION_UB_PASS_SLICE_INFO_CONV_ELTWISE_SLICE_INFO_H_
