...
#ifndef AIR_RUNTIME_LLM_ENGINE_COMMON_STRING_UTIL_H_
#define AIR_RUNTIME_LLM_ENGINE_COMMON_STRING_UTIL_H_
...
#endif  // AIR_RUNTIME_LLM_ENGINE_COMMON_STRING_UTIL_H_
