...
#ifndef AIR_RUNTIME_LLM_ENGINE_COMMON_SCOPE_GUARD_H_
#define AIR_RUNTIME_LLM_ENGINE_COMMON_SCOPE_GUARD_H_
...
#endif  // AIR_RUNTIME_LLM_ENGINE_COMMON_SCOPE_GUARD_H_
