...
if (TARGET datagw_headers)
    message(STATUS "Package datagw_headers has been found.")
    return()
endif()
...
if(datagw_INCLUDE_DIR)
    ...
    set_target_properties(datagw_headers PROPERTIES
            INTERFACE_INCLUDE_DIRECTORIES "${datagw_INCLUDE_DIR};${datagw_INCLUDE_DIR}/aicpu;"
    )
