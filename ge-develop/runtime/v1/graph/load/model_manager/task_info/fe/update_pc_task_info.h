...
#ifndef GE_GRAPH_LOAD_MODEL_MANAGER_TASK_INFO_UPDATE_PC_TASK_INFO_H
...
namespace ge {
class UpdatePCTaskInfo : public TaskInfo {
 public:
  UpdatePCTaskInfo() = default;
  ~UpdatePCTaskInfo() override = default;
...
#endif  // GE_GRAPH_LOAD_MODEL_MANAGER_TASK_INFO_UPDATE_PC_TASK_INFO_H
